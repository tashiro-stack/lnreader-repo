...
var a = require('cheerio'),
  ...
  r = (function () {
    ...
    return (
      (r.prototype.safeFetch = function (n) {
      ...
      (r.prototype.parseNovels = function (a) {
        return e(this, void 0, void 0, function () {
          ...
          return t(this, function (t) {
            return (
              (e = []),
              a('.top-novel-block').each(function (t, n) {
                var r = a(n).find('h2').text(),
                  o = a(n).find('.top-novel-cover img').attr('src'),
                  i = a(n).find('h2 a').attr('href');
                i && e.push({ name: r, cover: o, path: i.replace(l.site, '') });
              }),
              [2, e]
            );
          });
      ...
      (r.prototype.popularNovels = function (a, l) {
        return e(this, arguments, void 0, function (e, a) {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                for (n in ((l = new URLSearchParams()), s))
                  if ('keyword' === n) l.append('keyword', s[n].value);
                  else if ('object' == typeof s[n].value)
                    for (r = 0, o = s[n].value; r < o.length; r++)
                      (i = o[r]), l.append('include['.concat(n, '][]'), i);
                  else
                    s[n].value &&
                      l.append('include['.concat(n, '][]'), s[n].value);
                return l.toString()
                  ? (l.append('search', '1'),
                    [2, 1 == e ? this.detailedSearch(l) : []])
                  : [4, this.safeFetch(this.site + '/top-novel/' + e)];
              case 1:
      ...
      (r.prototype.searchNovels = function (a) {
        return e(this, void 0, void 0, function () {
          var e;
          return t(this, function (t) {
            return (
              (e = new URLSearchParams()).append('keyword', a),
              e.append('search', '1'),
              [2, this.detailedSearch(e)]
            );
          });
        });
      }),
      (r.prototype.detailedSearch = function (a) {
        return e(this, void 0, void 0, function () {
          var e;
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [
                  4,
                  this.safeFetch(this.site + '/detailed-search', {
                    method: 'POST',
                    headers: {
              ...
              case 1:
                return (e = t.sent()), [2, this.parseNovels(e)];
            }
          });
        });
      }),
      (r.prototype.parseNovel = function (a) {
        return e(this, void 0, void 0, function () {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [4, this.safeFetch(this.site + a)];
              case 1:
                return (
                  (e = t.sent()),
                  (l = {
                    path: a,
                    name: e('h1').text() || 'Untitled',
                    cover: e('.novel-cover').find('a > img').attr('src'),
                    chapters: [],
                  }),
                  e('.novel-detail-item').each(function (t, a) {
                    var n = e(a).find('h6').text(),
                      r = e(a).find('.novel-detail-body');
                    switch (n) {
                      case 'Description':
                        l.summary = r.text();
                        break;
                      ...
                      case 'Artist(s)':
                        ...
                        break;
                      case 'Status':
                        l.status = r.text().trim();
                    }
                  }),
                  (l.chapters = e('ul.chapter-chs > li > a')
                    .map(function (t, a) {
                      var l = e(a).attr('href');
                      return {
                        name: e(a).text(),
                        path: null == l ? void 0 : l.replace(n.site, ''),
                      };
                    })
                    .get()),
                  [2, l]
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [4, this.safeFetch(this.site + a)];
              case 1:
                return (e = t.sent()), [2, e('#contentall').html() || ''];
            }
          });
        });
      }),
