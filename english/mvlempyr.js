            ...
            for (; r && ((r = 0), s[0] && (o = 0)), o; )
              try {
                if (
                  ...
                  return i;
                switch (((t = 0), i && (s = [2 & s[0], i.value]), s[0])) {
                  case 0:
                  case 1:
                    i = s;
                    break;
  ...
  a =
    ...
    function (e, l, a) {
      if (a || 2 === arguments.length)
        for (var t, i = 0, o = l.length; i < o; i++)
          (!t && i in l) ||
            (t || (t = Array.prototype.slice.call(l, 0, i)), (t[i] = l[i]));
      return e.concat(t || Array.prototype.slice.call(l));
    };
Object.defineProperty(exports, '__esModule', { value: !0 });
var t = require('cheerio'),
  i = require('@libs/fetch'),
  o = require('@libs/filterInputs'),
  r = (function () {
    function r() {
      (this.id = 'mvlempyr.com'),
        (this.name = 'MVLEMPYR'),
        (this.icon = 'src/en/mvlempyr/icon.png'),
        (this.site = 'https://www.mvlempyr.io/'),
        (this.version = '1.0.13'),
        (this._chapSite = 'https://chap.heliosarchive.online/'),
        (this.filters = {
          order: {
            type: o.FilterTypes.Picker,
            value: 'reviewCount',
            label: 'Order by',
            options: [
          ...
          genre: {
            type: o.FilterTypes.ExcludableCheckboxGroup,
            label: 'Genres',
          ...
          tag: {
            ...
            options: [
              ...
              {
                label: 'Aggressive Characters',
                value: 'aggressive-characters',
              },
              ...
              {
                label: 'Apathetic Protagonist',
                value: 'apathetic-protagonist',
              },
              ...
              {
                label: 'Based on a Video Game',
                value: 'based-on-a-video-game',
              },
              {
                label: 'Based on a Visual Novel',
                value: 'based-on-a-visual-novel',
              },
              ...
              {
                label: 'Beautiful Female Lead',
                value: 'beautiful-female-lead',
              },
              ...
              {
                label: 'Confident Protagonist',
                value: 'confident-protagonist',
              },
              { label: 'Confinement', value: 'confinement' },
              {
                label: 'Conflicting Loyalties',
                value: 'conflicting-loyalties',
              },
              ...
              {
                label: 'Depictions of Cruelty',
                value: 'depictions-of-cruelty',
              },
              ...
              {
                label: 'Dishonest Protagonist',
                value: 'dishonest-protagonist',
              },
              {
                label: 'Distrustful Protagonist',
                value: 'distrustful-protagonist',
              },
              ...
              { label: 'Domestic Affairs', value: 'domestic-affairs' },
              {
                ...
                value: 'doting-love-interests',
              },
              {
                label: 'Doting Older Siblings',
                value: 'doting-older-siblings',
              },
              ...
              {
                label: 'Enemies Become Allies',
                value: 'enemies-become-allies',
              },
              {
                label: 'Enemies Become Lovers',
                value: 'enemies-become-lovers',
              },
              ...
              {
                label: 'First-time Interc**rse',
                value: 'first-time-interc-rse',
              },
              ...
              {
                label: 'Forgetful Protagonist',
                value: 'forgetful-protagonist',
              },
              { label: 'Former Hero', value: 'former-hero' },
              { label: 'Fox Spirits', value: 'fox-spirits' },
              {
                label: 'Friends Become Enemies',
                value: 'friends-become-enemies',
              },
              ...
              {
                label: 'Gate to Another World',
                value: 'gate-to-another-world',
              },
              {
                label: 'Genderless Protagonist',
                value: 'genderless-protagonist',
              },
              { label: 'Generals', value: 'generals' },
              {
                label: 'Genetic Modifications',
                value: 'genetic-modifications',
              },
              ...
              {
                label: 'God-human Relationship',
                value: 'god-human-relationship',
              },
              ...
              {
                label: 'Half-human Protagonist',
                value: 'half-human-protagonist',
              },
              ...
              {
                label: 'Hot-blooded Protagonist',
                value: 'hot-blooded-protagonist',
              },
              {
                label: 'Human Experimentation',
                value: 'human-experimentation',
              },
              ...
              {
                label: 'Indecisive Protagonist',
                value: 'indecisive-protagonist',
              },
              ...
              {
                label: 'Introverted Protagonist',
                value: 'introverted-protagonist',
              },
              ...
              {
                label: 'Masochistic Characters',
                value: 'masochistic-characters',
              },
              {
              ...
              {
                label: 'Multiple Protagonists',
                value: 'multiple-protagonists',
              },
              ...
              {
                label: 'Past Plays a Big Role',
                value: 'past-plays-a-big-role',
              },
              { label: 'Past Trauma', value: 'past-trauma' },
              {
                label: 'Pe*verted Protagonist',
                value: 'pe-verted-protagonist',
              },
              {
              ...
              {
                label: 'Popular Love Interests',
                value: 'popular-love-interests',
              },
              { label: 'Possession', value: 'possession' },
              {
                label: 'Possessive Characters',
                value: 'possessive-characters',
              },
              ...
              {
                label: 'Righteous Protagonist',
                value: 'righteous-protagonist',
              },
              ...
              {
                label: 'Tomboyish Female Lead',
                value: 'tomboyish-female-lead',
              },
              ...
              { label: 'Tragic Past', value: 'tragic-past' },
              {
                ...
                value: 'transformation-ability',
              },
              { label: 'Transmigration', value: 'transmigration' },
              {
                label: 'Transplanted Memories',
                value: 'transplanted-memories',
              },
              {
    ...
    return (
      (r.prototype.checkCaptcha = function (e) {
        var l = e('title').text();
        if (
          'Attention Required! | Cloudflare' === l ||
          'Just a moment...' === l
        )
          throw new Error('Captcha error, please open in webview');
      }),
      (r.prototype.popularNovels = function (a, t) {
              ...
              case 1:
                return (
                  ...
                  (i = t.filter(function (e) {
                    for (
                      var l = 0, a = n.genre.value.exclude || [];
                      l < a.length;
                      l++
                    ) {
                      var t = a[l];
                      if (e.genres.includes(t)) return !1;
                    }
                    for (
                      var i = 0, o = n.genre.value.include || [];
                      i < o.length;
                      i++
                    ) {
                      t = o[i];
                    ...
                    for (
                      var r = 0, s = n.tag.value.exclude || [];
                      r < s.length;
                      r++
                    ) {
                      var u = s[r];
                      if (e.tags.includes(u)) return !1;
                    }
                    for (
                      var v = 0, b = n.tag.value.include || [];
                      v < b.length;
                      v++
                    ) {
                      u = b[v];
                  ...
                  (o =
                    (null === (s = null == n ? void 0 : n.order) || void 0 === s
                      ? void 0
                      : s.value) || 'reviewCount'),
                  (r = i.sort(function (e, l) {
                    return l[o] - e[o];
                  })),
                  [
                    2,
                    this.paginate(r, e).map(function (e) {
                      return { name: e.name, path: e.path, cover: e.cover };
                    }),
                  ]
                );
            }
      ...
      (r.prototype.convertNovelId = function (e) {
        for (
          var l = 1999999997n, a = 1n, t = 7n, i = e;
          i > 0;
          1n === (1n & i) && (a = (a * t) % l), t = (t * t) % l, i >>= 1n
        );
        return a;
      }),
      (r.prototype.parseNovel = function (o) {
        return e(this, void 0, void 0, function () {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return (e = this.site + o), [4, (0, i.fetchApi)(e)];
              case 1:
              ...
              case 2:
                return (
                  ...
                  this.checkCaptcha(s),
                  (n = s('#novel-code').text()),
                  (u = this.convertNovelId(BigInt(parseInt(n)))),
                  [
                    4,
                    (0, i.fetchApi)(
                      this._chapSite +
              ...
              case 3:
                return (
                  (v = l.sent()),
                  (b = parseInt(v.headers.get('X-Wp-Totalpages')) || 1),
                  [4, v.json()]
                );
              case 4:
                return (
              ...
              case 5:
                return (
                  (c = a.apply(void 0, d.concat([l.sent(), !0])).flat()),
                  [
                    2,
                    {
                      path: o,
                      name: s('h1.novel-title').text() || 'Untitled',
                      cover: s('img.novel-image').attr('src'),
                      summary: s('div.synopsis.w-richtext').text().trim(),
                      chapters: c
                        .map(function (e) {
                          return {
                            name: e.acf.ch_name,
                            path:
                              ...
                              e.acf.novel_code +
                              '-' +
                              e.acf.chapter_number,
                            releaseTime: e.date,
                            chapterNumber: e.acf.chapter_number,
                          };
                        })
                        .reverse(),
                      status: s('.novelstatustextlarge').text(),
                      author: s(
                        ...
                        .filter(function (e) {
                          return (
                            2 == e.children.length &&
                            'Author:' === e.children[0].children[0].data
                          );
      ...
      (r.prototype.parseChapter = function (a) {
        return e(this, void 0, void 0, function () {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return [4, (0, i.fetchApi)(this.site + a)];
              case 1:
                return [4, l.sent().text()];
              case 2:
                return (
                  ...
                  (o = (0, t.load)(e)),
                  this.checkCaptcha(o),
                  [2, o('#chapter > span').html() || '']
                );
            }
          });
        });
      }),
      (r.prototype.searchNovels = function (a, t) {
        return e(this, void 0, void 0, function () {
          var e, i;
          return l(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return (
                  ...
                  [
                    2,
                    this.paginate(i, t).map(function (e) {
                      return { name: e.name, path: e.path, cover: e.cover };
                    }),
                  ]
                );
      ...
      (r.prototype.paginate = function (e, l) {
        var a = 20 * (l - 1),
          t = a + 20;
        return e.slice(a, t);
      }),
      (r.prototype.getAllNovels = function () {
        return e(this, void 0, void 0, function () {
          var e;
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return this._allNovelsPromise
                  ? [4, this._allNovelsPromise]
                  : [3, 2];
              case 1:
                l.sent(), (l.label = 2);
              case 2:
                if (this._allNovels) return [2, this._allNovels];
                (this._allNovelsPromise = this.loadAll()), (l.label = 3);
              case 3:
                return (
                  l.trys.push([3, , 5, 6]),
                  (e = this),
              ...
              case 4:
                return (e._allNovels = l.sent()), [3, 6];
              case 5:
                ...
                return [
                  ...
                  e.sent().map(function (e) {
                    return {
                      name: e.name,
                      path: 'novel/' + e.slug,
                      cover: 'https://assets.mvlempyr.app/images/600/'.concat(
                        e['novel-code'],
                        '.webp',
                      ),
                      avgReview: e['average-review'],
                      reviewCount: e['total-reviews'],
                      chapterCount: e['total-chapters'],
                      created: new Date(e.createdOn).getTime(),
                      genres: e.genre,
                      tags: e.tags,
                      random: Math.random(),
                    };
