...
var t,
  ...
  v = (function () {
      ...
      (this.id = 'FuckNovelpia'),
        ...
        (this.filters = {
          ...
          genres: {
            ...
            type: s.FilterTypes.ExcludableCheckboxGroup,
          },
          ...
          tags: {
            ...
            options: [
              ...
              {
                label: 'Mastermind Protagonist',
                value: 'mastermind protagonist',
              },
              ...
              {
                label: 'Reincarnated Villainess',
                value: 'reincarnated villainess',
              },
          ...
          author: { label: 'Author', value: '', type: s.FilterTypes.TextInput },
          uploader: {
            label: 'Uploader',
            value: '',
            type: s.FilterTypes.TextInput,
          },
          translator_group: {
    ...
    return (
      (v.prototype.hasRequestedPage = function (e, l) {
        if (l <= 1) return !0;
        var a = e('div.pagination a.active').first().text().trim(),
          t = parseInt(a, 10);
        return !isNaN(t) && t === l;
      }),
      (v.prototype.parseNovelsList = function (e) {
        var l = [],
          a = new Set();
        return (
          e('.card-book a').each(function (t, r) {
            var i = e(r),
              o = i.attr('href');
            if (o) {
              var u = o.startsWith('/') ? o.slice(1) : o;
              if (!a.has(u)) {
                var s = i.find('img').attr('src'),
                  v =
                    i.find('img').attr('alt') || i.find('.title').text().trim();
                a.add(u),
                  l.push({ path: u, name: v, cover: s || n.defaultCover });
              }
            }
          }),
          l
      ...
      (v.prototype.parseLatestUpdates = function () {
        return l(this, void 0, void 0, function () {
          var l, r, n, o, s, v, b, c, p, d;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (l = this.site + 'updates.php'), [4, (0, u.fetchApi)(l)];
              case 1:
              ...
              case 2:
                return (
                  ...
                  (p = function () {
                    return v.length > 1 ? v.pop() : b();
                  }),
                  (d = new i.Parser({
                    onopentag: function (l, a) {
                      var r = b();
                      if (
                        ('updates-list' === a.class && c(t.NovelList),
                        r !== t.Idle)
                      )
                        switch (l) {
                          case 'a':
                            if (s.has(a.href)) return;
                            s.add(a.href),
                              c(t.Novel),
                              (o.path = a.href.substring(1));
                            break;
                          case 'img':
                            (o.cover = a.src), (o.name = a.alt);
                            break;
                          case 'div':
                            switch (a.class) {
                              case 'copy':
                                o.name && o.path && (n.push(e({}, o)), p()),
                                  (o = {});
                                break;
                              case 'install-banner':
                                p();
      ...
      (v.prototype.popularNovels = function (e, t) {
        return l(this, arguments, void 0, function (e, l) {
          var t,
            ...
            D,
            L,
            G = l.showLatestNovels,
            R = l.filters;
          return a(this, function (l) {
            switch (l.label) {
              case 0:
                if (G) return [2, this.parseLatestUpdates()];
                for (
                  (t = new URLSearchParams()).set('q', ''),
                    t.set('sort', R.sort.value),
                    i = 0,
                    n = [
                      'author',
                      'uploader',
                  ...
                  (o = n[i]), t.set(o, R[o].value);
                for (
                  t.set('status', R.status.value),
                    t.set('language', R.lang.value),
                    t.set('read_only', R.read_only.value),
                    (null === (S = R.has_images) || void 0 === S
                      ? void 0
                      : S.value) && t.set('has_images', '1'),
                    t.set('genre_mode', R.genres_include_operator.value),
                    s = 0,
                    v =
                      null !==
                        (x =
                  ...
                  (h = v[s]), t.append('genres_include[]', h);
                for (
                  b = 0,
                    c =
                      null !==
                  ...
                  (h = c[b]), t.append('genres_exclude[]', h);
                for (
                  t.set('tag_mode', R.tags_include_operator.value),
                    p = 0,
                    d =
                      null !==
                        (M =
                ...
                for (
                  ...
                  (h = m[g]), t.append('tags_exclude[]', h);
                return (
                  e > 1 && t.set('page', String(e)),
                  (y = this.site + 'search.php?' + t.toString()),
                  [4, (0, u.fetchApi)(y)]
                );
              case 1:
              ...
              case 2:
                return (
                  (f = l.sent()),
                  (w = (0, r.load)(f)),
                  this.hasRequestedPage(w, e)
                    ? [2, this.parseNovelsList(w)]
                    : [2, []]
                );
            }
          });
      ...
      (v.prototype.parseNovel = function (e) {
        return l(this, void 0, void 0, function () {
          var l, t, i, s, v, b, c, p, d, g, m, h, y;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, (0, u.fetchApi)(this.site + e)];
              case 1:
                return [4, a.sent().text()];
              case 2:
                (l = a.sent()),
                  (t = (0, r.load)(l)),
                  (i = t('script[type="application/ld+json"]').text()),
                  (s = {});
                try {
                  s = JSON.parse(i);
                } catch (e) {}
                return (
                  (v = s.name || t('h1').text().trim()),
                  (b = s.image || n.defaultCover),
                  (c = s.description || t('.hero-summary').text().trim()),
                  (p = [s.author]
                    .flat()
                    .map(function (e) {
                    ...
                    (p = t('.info-list li')
                      ...
                      .replace(/^Author:\s*/i, '')
                      .trim()),
                  (d = [s.genre].flat().filter(Boolean).join(',')) ||
                    (d = t('.genre-pill')
                      .map(function (e, l) {
                        return t(l).text().trim();
                      })
                      .get()
                      .filter(Boolean)
                      .join(',')),
                  ...
                  (g.status = h[m.toLowerCase()] || o.NovelStatus.Unknown),
                  (y = []),
                  t('#chapter-list li').each(function (e, l) {
                    var a = t(l),
                      r = (a.find('a').attr('href') || '').trim(),
                      i = r.startsWith('/') ? r.slice(1) : r,
                      n = a.find('.chapter-item-main').text().trim();
                    i &&
                      n &&
                      y.push({
                        name:
                          n +
                          (a.find('.chapter-item-flag').length ? ' [IMG]' : ''),
                        path: i,
                        chapterNumber: Number(a.attr('data-ch')),
                      });
                  }),
                  (g.chapters = y),
                  [2, g]
      ...
      (v.prototype.parseChapter = function (e) {
        return l(this, void 0, void 0, function () {
          var l, t, i, n, o;
          return a(this, function (a) {
            switch (a.label) {
              ...
              case 2:
                return (
                  (l = a.sent()),
                  (t = (0, r.load)(l)),
                  (i = t('.reader').first()).length
                    ? (i.find('.reader-nav').remove(),
                      ...
                      [
                        ...
                        null !==
                          (o =
                            null === (n = i.html()) || void 0 === n
                              ? void 0
                              : n.replace(/&nbsp;/g, ' ')) && void 0 !== o
                          ? o
                          : '',
                      ])
                    : [2, '']
      ...
      (v.prototype.searchNovels = function (e, t) {
        return l(this, void 0, void 0, function () {
          var l, i, n, o;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (
                  (l = new URLSearchParams()).set('q', e),
                  l.set('author', ''),
                  l.set('uploader', ''),
                  l.set('translator_group', ''),
                  l.set('country', ''),
                  l.set('year_from', ''),
                  l.set('year_to', ''),
                  l.set('status', ''),
                  ...
                  l.set('sort', 'newest'),
                  l.set('tag_mode', 'AND'),
                  l.set('genre_mode', 'AND'),
                  t > 1 && l.set('page', String(t)),
                  (i = this.site + 'search.php?' + l.toString()),
                  [4, (0, u.fetchApi)(i)]
                );
              case 1:
                return [4, a.sent().text()];
              case 2:
                return (
                  (n = a.sent()),
                  (o = (0, r.load)(n)),
                  this.hasRequestedPage(o, t)
                    ? [2, this.parseNovelsList(o)]
                    : [2, []]
                );
            }
          });
