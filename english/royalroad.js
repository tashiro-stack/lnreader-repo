  ...
  u = (function () {
    function u() {
      (this.id = 'royalroad'),
        ...
        (this.enableVol = o.storage.get('enableVol')),
        (this.pluginSettings = {
          enableVol: {
            value: '',
        ...
        (this.filters = {
          keyword: {
            type: i.FilterTypes.TextInput,
            label: 'Keyword (title or description)',
            value: '',
          },
          author: { type: i.FilterTypes.TextInput, label: 'Author', value: '' },
          genres: {
            type: i.FilterTypes.ExcludableCheckboxGroup,
            label: 'Genres',
    ...
    return (
        ...
        var a = this.site,
          ...
          o = new t.Parser({
            onopentag: function (e, t) {
              var n;
              if (
                ((null === (n = t.class) || void 0 === n
                  ? void 0
                  : n.includes('fiction-list-item')) && (r = l.Novel),
                r === l.Novel)
              )
                switch (e) {
                  case 'a':
                    t.href &&
                      (i.path = t.href.split('/').slice(1, 3).join('/'));
                    break;
                  case 'img':
                    t.src &&
                      ((i.name = t.alt || ''),
                      (i.cover = (0, s.isUrlAbsolute)(t.src)
                        ? t.src
                        : a + t.src.slice(1)));
                }
            },
            onclosetag: function (e) {
              'figure' === e &&
                (i.path && i.name && (n.push(i), (i = {})), (r = l.Idle));
            },
          });
        return o.write(e), o.end(), n;
      }),
      (u.prototype.popularNovels = function (l, t) {
        return e(this, arguments, void 0, function (e, l) {
          var t,
            ...
            d,
            b = l.filters,
            h = l.showLatestNovels;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                for (i in ((t = new URLSearchParams({ page: e.toString() })),
                h && t.append('orderBy', 'last_update'),
                b || (b = this.filters || {}),
                b))
                  if ('' !== b[i].value)
                    if (
                      ...
                      if (b[i].value.include)
                        for (r = 0, s = b[i].value.include; r < s.length; r++)
                          (o = s[r]), t.append('tagsAdd', o);
                      if (b[i].value.exclude)
                        for (u = 0, c = b[i].value.exclude; u < c.length; u++)
                          (p = c[u]), t.append('tagsRemove', p);
                    } else t.append(i, String(b[i].value));
                return (
                  (v = ''
                    .concat(this.site, 'fictions/search?')
                    .concat(t.toString())),
                  [
                    4,
                    (0, n.fetchApi)(v).then(function (e) {
                      return e.text();
                    }),
                  ]
                );
              case 1:
                return (d = a.sent()), [2, this.parseNovels(d)];
            }
          });
        });
      }),
      (u.prototype.parseNovel = function (i) {
        return e(this, void 0, void 0, function () {
          var e, o, u, c, p, v, d, b, h, f, g, y, I, m;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                  ...
                  (m = new t.Parser({
                    onopentag: function (e, a) {
                      ...
                      switch (e) {
                        case 'h1':
                          ...
                          break;
                        case 'a':
                          (null === (t = a.href) || void 0 === t
                            ? void 0
                            : t.startsWith('/profile/')) && !o.author
                            ? (p = l.InAuthor)
                            : p === l.InTags && (p = l.InTagLink);
                          break;
                        case 'div':
                          'description' === a.class && (p = l.InDescription);
                          break;
                        case 'hr':
                        ...
                        case 'span':
                          (
                            null === (n = a.class) || void 0 === n
                              ? void 0
                              : n.includes('tags')
                          )
                            ? (p = l.InTags)
                            : (null === (i = a.class) || void 0 === i
                                ? void 0
                                : i.includes('label-sm')) &&
                              2 === ++d &&
                              ((p = l.InStatusSpan), (v = ''));
                          break;
                        case 'img':
                          (null === (r = a.class) || void 0 === r
                            ? void 0
                            : r.includes('thumbnail')) &&
                            ((o.cover = a.src),
                            o.cover &&
                              !(0, s.isUrlAbsolute)(o.cover) &&
                              (o.cover = u + o.cover.slice(1)));
                          break;
                        case 'script':
                          p = l.InScript;
                      }
                    ...
                    onclosetag: function (e) {
                      switch (e) {
                        case 'h1':
                          p === l.InTitle &&
                            ((o.name = b.join('').trim()), (p = l.Idle));
                          break;
                        case 'a':
                          p === l.InTagLink
                            ? (p = l.InTags)
                            : p === l.InAuthor && (p = l.Idle);
                          break;
                        case 'p':
                          p === l.InDescription && h.push('\n\n');
                          break;
                        ...
                        case 'span':
                          p === l.InTags
                            ? ((o.genres = g.join(', ')), (p = l.Idle))
                            : p === l.InStatusSpan && (p = l.Idle);
                          break;
                        case 'script':
                          if (p === l.InScript) {
                            p = l.Idle;
                            var a = f.join(''),
                              t = a.match(/window\.chapters\s*=\s*(\[.*?\]);/),
                              n = a.match(/window\.volumes\s*=\s*(\[.*?\]);/);
                            (null == t ? void 0 : t[1]) &&
                              (y = JSON.parse(t[1])),
                              (null == n ? void 0 : n[1]) &&
                                c &&
                    ...
                    onend: function () {
                      ...
                      o.chapters = y.map(function (e) {
                        var a,
                          l = I.find(function (a) {
                            return a.id === e.volumeId;
                          });
                        return {
                          name: e.title,
                          path:
                            ...
                            ''
                              ...
                              .concat(a[5])),
                          releaseTime: e.date,
                          chapterNumber: null == e ? void 0 : e.order,
                          page: null == l ? void 0 : l.title,
                        };
                      });
                    },
                  })),
      ...
      (u.prototype.parseChapter = function (i) {
        return e(this, void 0, void 0, function () {
          var e, r, s, o, u, c, p, v, d, b, h, f, g, y, I, m, S;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, (0, n.fetchApi)(this.site + i)];
              ...
              case 2:
                return (
                  ...
                  (b = e.match(/<style>\n\s+.(.+?){[^{]+?display: none;/)),
                  (h =
                    null === (S = null == b ? void 0 : b[1]) || void 0 === S
                      ? void 0
                      : S.trim()),
                  (f = null),
                  (g = /[&<>"']/g),
                  ...
                  (m = new t.Parser({
                    onopentag: function (e, a) {
                      o++;
                      var t = a.class || '';
                      if (r !== l.InHidden && h && t.includes(h))
                        return (
                          (f = { state: r, depth: s }),
                          (r = l.InHidden),
                          void (s = o)
                      ...
                      switch (r) {
                        case l.Idle:
                          t.includes('chapter-content')
                            ? ((r = l.InChapter), (s = o), (d = !1))
                            : t.includes('author-note-portlet') &&
                              ((r = l.InNote), (s = o));
                          break;
                        case l.InHidden:
                          return;
                      }
                      if (r === l.InChapter || r === l.InNote) {
                        var n = '<'.concat(e);
                        for (var i in a) {
                          var p = a[i].replace(/"/g, '&quot;');
                          n += ' '.concat(i, '="').concat(p, '"');
                        }
                        (n += '>'), r === l.InChapter ? u.push(n) : c.push(n);
                      }
                    },
                    ontext: function (e) {
                      switch (r) {
                      ...
                      if (o === s)
                        switch (r) {
                          case l.InHidden:
                            return (
                              f
                                ? ((r = f.state), (s = f.depth), (f = null))
                                : ((r = l.Idle), (s = 0)),
                              void o--
                            );
                          case l.InChapter:
                            return (
                              u.push('</div>'), (r = l.Idle), (s = 0), void o--
                            );
                          case l.InNote:
                            var a = 'author-note-'.concat(
                                d ? 'before' : 'after',
                              ),
                              t = c.join('').trim(),
                              n = '<div class="'
                        ...
                        (r === l.InChapter || r === l.InNote) &&
                        !m.isVoidElement(e)
                      ) {
                        var i = '</'.concat(e, '>');
                        r === l.InChapter ? u.push(i) : c.push(i);
                      }
                      o--;
                    },
                  })).write(e),
            ...
            switch (a.label) {
              case 0:
                return (
                  ...
                  [
                    4,
                    (0, n.fetchApi)(i).then(function (e) {
                      return e.text();
                    }),
                  ]
                );
...
(exports.default = new u()),
  (function (e) {
    (e[(e.Idle = 0)] = 'Idle'),
      (e[(e.InTitle = 1)] = 'InTitle'),
      (e[(e.InAuthor = 2)] = 'InAuthor'),
      (e[(e.InDescription = 3)] = 'InDescription'),
      (e[(e.InTags = 4)] = 'InTags'),
      (e[(e.InTagLink = 5)] = 'InTagLink'),
      (e[(e.InStatusSpan = 6)] = 'InStatusSpan'),
      (e[(e.InScript = 7)] = 'InScript'),
      (e[(e.InNote = 8)] = 'InNote'),
      (e[(e.InChapter = 9)] = 'InChapter'),
      (e[(e.InHidden = 10)] = 'InHidden'),
      (e[(e.Novel = 11)] = 'Novel');
  })(l || (l = {}));
