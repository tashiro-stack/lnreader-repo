...
var l = require('cheerio'),
  ...
  o = (function () {
    ...
    return (
      ...
      (o.prototype.safeFecth = function (l, t) {
                ...
                if (
                  ...
                  (u =
                    null ===
                      ...
                      ? void 0
                      : v.trim()),
                  this.getHostname(l) != this.getHostname(i.url) ||
                    (u &&
                      ('Bot Verification' == u ||
      ...
      (o.prototype.popularNovels = function (l, t) {
              ...
              case 0:
                for (n in ((t =
                  null !==
                    ...
                    ? v
                    : '/series/'),
                (r = this.site + t + '?page=' + e),
                h || (h = this.filters || {}),
                b && (r += '&order=latest'),
                h))
                  if ('object' == typeof h[n].value)
                    for (s = 0, i = h[n].value; s < i.length; s++)
                      (o = i[s]), (r += '&'.concat(n, '=').concat(o));
                  else
                    h[n].value && (r += '&'.concat(n, '=').concat(h[n].value));
      ...
      (o.prototype.parseNovel = function (l) {
        return e(this, void 0, void 0, function () {
          var e, r, i, o, c, v, h, b, d, p, m, f, g, y, w, k, S, N, L, x, C;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                  ...
                  (x = new t.Parser({
                    onopentag: function (a, l) {
                      ...
                      (null === (t = l.class) || void 0 === t
                        ...
                        ? ((i.name = l.title),
                          (i.cover = l['data-src'] || l.src || s.defaultCover))
                    ...
                    ontext: function (e) {
                      var a, l;
                      if (o) c && (i.genres += e + ', ');
                      else if (1 === v && e.trim()) i.summary += e;
                      else if (h) {
                        if (b) {
                          var t = e.toLowerCase().replace(':', '').trim();
                          if (d) i.author += e || 'Unknown';
                          else if (p) i.artist += e || 'Unknown';
                          else if (m)
                            switch (t) {
                              case 'مكتملة':
                              case 'completed':
                              ...
                              case 'completado':
                              case 'tamamlandı':
                                i.status = n.NovelStatus.Completed;
                                break;
                              case 'مستمرة':
                              case 'ongoing':
                              case 'en cours':
                              ...
                              case 'en progreso':
                              case 'devam ediyor':
                                i.status = n.NovelStatus.Ongoing;
                                break;
                              case 'متوقفة':
                              case 'hiatus':
                              case 'en pause':
                              ...
                              case 'pausado':
                              case 'duraklatıldı':
                                i.status = n.NovelStatus.OnHiatus;
                                break;
                              default:
                                i.status = n.NovelStatus.Unknown;
                            }
                          switch (t) {
                            case 'الكاتب':
                            case 'author':
                          ...
                          : h
                            ? b
                              ...
                              : 'div' === e &&
                                ((h = !1),
                                (i.author =
                                  null === (l = i.author) || void 0 === l
                                    ? void 0
                                    : l.trim()),
                                (i.artist =
                                  null === (t = i.artist) || void 0 === t
                                    ? void 0
                                    : t.trim()))
                            : f &&
                              (g
      ...
      (o.prototype.searchNovels = function (l, t) {
        return e(this, void 0, void 0, function () {
          var e, r;
          return a(this, function (a) {
            switch (a.label) {
