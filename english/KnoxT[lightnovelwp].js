...
var l = require('cheerio'),
  ...
  n = (function () {
    ...
    return (
      ...
      (n.prototype.safeFecth = function (l, t) {
              ...
              case 2:
                if (
                  ...
                  (u =
                    null ===
                      (c =
                        null === (v = n.match(/<title>(.*?)<\/title>/)) ||
                        void 0 === v
                          ? void 0
                          : v[1]) || void 0 === c
                      ? void 0
                      : c.trim()),
                  this.getHostname(l) != this.getHostname(s.url) ||
                    (u &&
                      ('Bot Verification' == u ||
      ...
      (n.prototype.popularNovels = function (l, t) {
              ...
              case 0:
                for (o in ((t =
                  null !==
                    ...
                    ? c
                    : '/series/'),
                (i = this.site + t + '?page=' + e),
                b || (b = this.filters || {}),
                d && (i += '&order=latest'),
                b))
                  if ('object' == typeof b[o].value)
                    for (r = 0, s = b[o].value; r < s.length; r++)
                      (n = s[r]), (i += '&'.concat(o, '=').concat(n));
                  else
                    b[o].value && (i += '&'.concat(o, '=').concat(b[o].value));
      ...
      (n.prototype.parseNovel = function (l) {
        return e(this, void 0, void 0, function () {
          var e, i, s, n, v, c, b, d, h, p, g, m, f, y, w, C, k, S, L, P, N;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                ...
                return (
                  ...
                  (P = new t.Parser({
                    onopentag: function (a, l) {
                      var t;
                      !s.cover &&
                      (null === (t = l.class) || void 0 === t
                        ? void 0
                        : t.includes('ts-post-image'))
                        ? ((s.name = l.title),
                          (s.cover = l['data-src'] || l.src || r.defaultCover))
                    ...
                    ontext: function (e) {
                      var a, l;
                      if (n) v && (s.genres += e + ', ');
                      else if (1 === c && e.trim()) s.summary += e;
                      else if (b) {
                        if (d) {
                          var t = e.toLowerCase().replace(':', '').trim();
                          if (h) s.author += e || 'Unknown';
                          else if (p) s.artist += e || 'Unknown';
                          else if (g)
                            switch (t) {
                              case 'مكتملة':
                              case 'completed':
                              ...
                              case 'completado':
                              case 'tamamlandı':
                                s.status = o.NovelStatus.Completed;
                                break;
                              case 'مستمرة':
                              case 'ongoing':
                              case 'en cours':
                              ...
                              case 'en progreso':
                              case 'devam ediyor':
                                s.status = o.NovelStatus.Ongoing;
                                break;
                              case 'متوقفة':
                              case 'hiatus':
                              case 'en pause':
                              ...
                              case 'pausado':
                              case 'duraklatıldı':
                                s.status = o.NovelStatus.OnHiatus;
                                break;
                              default:
                                s.status = o.NovelStatus.Unknown;
                            }
                          switch (t) {
                            case 'الكاتب':
                            case 'author':
                          ...
                          : b
                            ? d
                              ...
                              : 'div' === e &&
                                ((b = !1),
                                (s.author =
                                  null === (l = s.author) || void 0 === l
                                    ? void 0
                                    : l.trim()),
                                (s.artist =
                                  null === (t = s.artist) || void 0 === t
                                    ? void 0
                                    : t.trim()))
                            : m &&
                              (f
      ...
      (n.prototype.parseChapter = function (t) {
        return e(this, void 0, void 0, function () {
          var e, i, o, r, s;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, this.safeFecth(this.site + t, !1)];
              case 1:
                if (
                  ((e = a.sent()),
      ...
      (n.prototype.searchNovels = function (l, t) {
        return e(this, void 0, void 0, function () {
          var e, i;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (
                  (e =
                    this.site + 'page/' + t + '/?s=' + encodeURIComponent(l)),
