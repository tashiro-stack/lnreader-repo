...
var r = require('cheerio'),
  ...
  a = (function () {
    ...
    return (
      (a.prototype.novel = function () {
        return e(this, void 0, void 0, function () {
          var t, e, o;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return null !== this.cachedNovel
                  ? [2, this.cachedNovel]
                  : [4, (0, i.fetchApi)(this.site)];
              case 1:
              ...
              case 2:
                return (
                  (t = n.sent()),
                  (e = (0, r.load)(t)),
                  (o = e('.entry-content h1 img').last().attr('src')),
                  (this.cachedNovel = {
      ...
      (a.prototype.popularNovels = function (t) {
        return e(this, void 0, void 0, function () {
          var e, r, i;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return (
                  (e = []),
                  1 !== t ? [3, 2] : ((i = (r = e).push), [4, this.novel()])
                );
              case 1:
                i.apply(r, [n.sent()]), (n.label = 2);
              case 2:
                return [2, e];
            }
          });
      ...
      (a.prototype.searchNovels = function (t) {
        return e(this, void 0, void 0, function () {
          var e,
            r,
            i = this;
              ...
              case 1:
                return (
                  ...
                  [
                    ...
                    e.filter(function (t) {
                      var e = t.name;
                      return i.normalize(e).includes(r);
                    }),
                  ]
                );
            }
      ...
      (a.prototype.parseChapter = function (t) {
        return e(this, void 0, void 0, function () {
          var e, o, a, s;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, (0, i.fetchApi)(this.site + t)];
              case 1:
                return [4, n.sent().text()];
              case 2:
                return (
                  (e = n.sent()),
                  (o = (0, r.load)(e)),
                  (a = o('h1.entry-title').text().trim()),
                  (s = o('.entry-content').first())
                    .find(
                      '#patreon-snippet, .sharedaddy, .jp-relatedposts, #jp-post-flair',
                    )
                    .remove(),
                  [2, '<h1>'.concat(a, '</h1>').concat(s.html() || '')]
                );
            }
          });
        });
                ...
                return (
                  ...
                  [
                    ...
                    t(t({}, c), {
                      ...
                      chapters: this.parseChaptersFromTOC(l),
                      status: o.NovelStatus.Ongoing,
                      summary:
      ...
      (a.prototype.parseChaptersFromTOC = function (t) {
        for (
          var e = [],
            n = 0,
            r = 0,
            i = 0,
            o = t('.entry-content').first().children().toArray();
          i < o.length;
          i++
        ) {
          var a = o[i];
              ...
              'ul' !== s ||
                ...
                t(a)
                  ...
                  .each(function (i, o) {
                    ...
                    if (
                      a &&
                      /^https?:\/\/(?:www\.)?witchculttranslation\.com\//i.test(
                        a,
                      )
                    ) {
                      var s = t(o).text().trim();
                      if (s) {
                        var c = '/'.concat(
                            a
                              .replace(
                                /^https?:\/\/(?:www\.)?witchculttranslation\.com\//i,
                                '',
                              )
                              .replace(/^\/+/, ''),
                          ),
                          l = c.match(/^\/(\d{4})\/(\d{2})\/(\d{2})\//),
                          u = l
                            ? ''
                                .concat(l[1], '-')
                                .concat(l[2], '-')
