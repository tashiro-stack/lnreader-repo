...
var t = require('@libs/filterInputs'),
  ...
  s = (function () {
    function a() {
      ...
      (this.id = 'AT'),
        ...
        (this.resolveUrl = function (l, a) {
          return e.site + (a ? '/work/' : '/reader/') + l;
        }),
        (this.filters = {
          sort: {
            label: 'Сортировка',
    ...
    return (
      (a.prototype.parseNovels = function (e) {
        return (0, i.fetchApi)(e, { headers: { 'User-Agent': this.userAgent } })
          .then(function (e) {
            return e.text();
          })
          .then(function (e) {
            var l = [],
              ...
              i = !1,
              n = new o.Parser({
                onopentag: function (e, l) {
                  'a' === e &&
                    'work-row item-link item-content' === l.class &&
                    l.href &&
                    ((a.path = l.href.replace(/\D/g, '')), (t = !0)),
                    t && 'h4' === e && 'work-title' === l.class && (i = !0),
                    t &&
                      'img' === e &&
                      'Обложка' === l.alt &&
                      (a.cover = l['data-src']);
                ...
                onclosetag: function (e) {
                  'h4' === e && (i = !1),
                    'a' === e &&
                      t &&
                      (a.cover || (a.cover = r.defaultCover),
                      l.push(a),
                      (a = {}),
                      (t = !1));
                },
              });
            return n.write(e), n.end(), l;
          });
      }),
      (a.prototype.popularNovels = function (a, t) {
          ...
          return l(this, function (l) {
            return (
              (t =
                this.site +
                '/work/genre/' +
                ((null === (r = null == h ? void 0 : h.genre) || void 0 === r
                  ? void 0
                  : r.value) || 'all')),
              (t +=
                '?sorting=' +
                (c
                  ? 'recent'
                  : (null === (i = null == h ? void 0 : h.sort) || void 0 === i
                      ? void 0
                      : i.value) || 'popular')),
              (null === (n = null == h ? void 0 : h.form) || void 0 === n
                ? void 0
                : n.value) && (t += '&form=' + h.form.value),
              (null === (o = null == h ? void 0 : h.state) || void 0 === o
                ? void 0
                : o.value) && (t += '&state=' + h.state.value),
              (null === (u = null == h ? void 0 : h.series) || void 0 === u
                ? void 0
                : u.value) && (t += '&series=' + h.series.value),
              (null === (s = null == h ? void 0 : h.access) || void 0 === s
                ? void 0
                : s.value) && (t += '&access=' + h.access.value),
              (null === (v = null == h ? void 0 : h.promo) || void 0 === v
                ? void 0
                : v.value) && (t += '&promo=' + h.promo.value),
              (t += '&page=' + e),
      ...
      (a.prototype.parseNovel = function (a) {
        return e(this, void 0, void 0, function () {
          var e, t, s, v, c, h, p, b, f, d, y, m;
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return [
                  4,
                  (0, i.fetchApi)(this.resolveUrl(a, !0), {
              ...
              case 1:
                return (
                  ...
                  (m = new o.Parser({
                    onopentag: function (e, l) {
                      'h1' === e && 'card-title' === l.class && (v = !0),
                        'img' === e &&
                          'cover-image' === l.class &&
                          (t.cover = l.src),
                        'a' === e &&
                          l.href &&
                          l.href.endsWith('/works') &&
                          (c = !0),
                        'div' === e && 'rich-content' === l.class && (h = !0),
                        'br' === e && h && (t.summary += '\n'),
                        'noindex' === e &&
                          ((p = !0), t.genres && (t.genres = '')),
                        'label' === e &&
                          l.class &&
                          l.class.includes('label') &&
                          (b = !0),
                        'li' === e && 'clearfix' === l.class && (f = !0),
                        'a' === e &&
                          f &&
                          l.href &&
                          ((d = !0), (y.path = l.href.replace('/reader/', ''))),
                        'span' === e &&
                          l['data-time'] &&
                          (y.releaseTime = (0, u.default)(
                            l['data-time'],
                          ).format('LLL'));
                    },
                    ontext: function (e) {
                      if (
                        ...
                        switch (e.trim()) {
                          case 'в процессе':
                            t.status = n.NovelStatus.Ongoing;
                            break;
                          case 'весь текст':
                            t.status = n.NovelStatus.Completed;
                            break;
                          default:
                    ...
                    onclosetag: function (e) {
                      ...
                      'div' === e &&
                        ...
                        'li' === e &&
                          f &&
                          ((y.chapterNumber = s.length),
                          y.path && (null == s || s.push(y)),
                          (y = {}),
                          (f = !1));
                    },
                  })),
                  m.write(e),
                  m.end(),
                  t.cover || (t.cover = r.defaultCover),
                  s.length || s.push({ name: 'Рассказ', path: a }),
                  (t.chapters = s),
                  [2, t]
                );
            }
      ...
      (a.prototype.parseChapter = function (a) {
        return e(this, void 0, void 0, function () {
          var e, t, r, n, o, u, s, v, c, h, p, b, f, d, y;
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return [
                  4,
                  (0, i.fetchApi)(this.resolveUrl(a), {
                    headers: { 'User-Agent': this.userAgent },
                  }).then(function (e) {
                    return e.text();
                  }),
              ...
              case 1:
                if (
                  ...
                  (u =
                    null ===
                      (f =
                        null === (b = e.match(/userId:(.*?),/)) || void 0 === b
                          ? void 0
                          : b[1]) || void 0 === f
                      ? void 0
                      : f.trim()),
                ...
                return [
                  4,
                  (0, i.fetchApi)(
                    this.site + '/reader/' + r + '/chapter?id=' + o,
                    { headers: { 'User-Agent': this.userAgent } },
                  ),
                ];
              case 2:
                return [4, (v = l.sent()).json()];
              case 3:
                if (((c = l.sent()), !(h = v.headers.get('reader-secret'))))
                  throw new Error('Failed to find the token\n' + c.messages);
                return (
                  (p = (function (e, l, a) {
                    void 0 === a && (a = '');
                    for (
                      var t = (l.split('').reverse().join('') + '@_@' + a)
                          .split('')
                          .map(function (e) {
                      ...
                      i += String.fromCharCode(e.charCodeAt(n) ^ t[n % r]);
                    return i;
                  })(c.data.text, h, s)),
                  [2, p]
                );
        ...
        return e(this, arguments, void 0, function (e, a) {
          ...
          return (
            ...
            l(this, function (l) {
              return (
                (t =
                  this.site + '/search?category=works&q=' + e + '&page=' + a),
                [2, this.parseNovels(t)]
              );
            })
          );
