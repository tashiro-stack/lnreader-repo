      ...
      (this.id = 'jaomix.ru'),
        ...
        (this.parseDate = function (e) {
          ...
          var l = {
            ...
            r = a[3];
          return t && n && l[i] && r
            ? (0, o.default)(r + '-' + l[i] + '-' + n + ' ' + t).format('LLL')
            : e || null;
        }),
        (this.filters = {
          sortby: {
          ...
          genre: {
            ...
            type: t.FilterTypes.ExcludableCheckboxGroup,
          },
          lang: {
            label: 'Выбрать языки:',
            value: [],
            ...
            type: t.FilterTypes.CheckboxGroup,
          },
        });
    }
    return (
        ...
        return e(this, arguments, void 0, function (e, a) {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return (
                  (t = this.site + '/?searchrn'),
                  (null ===
                    (c =
                      null === (s = null == k ? void 0 : k.lang) || void 0 === s
                        ? void 0
                        : s.value) || void 0 === c
                    ? void 0
                    : c.length) &&
                  ...
                  (null ===
                    ...
                    ? void 0
                    : p.length) &&
                    (t += k.genre.value.include
                      .map(function (e, l) {
                        return '&genre['.concat(l, ']=').concat(e);
                      })
                      .join('')),
                  (null ===
                    (f =
                    ...
                    ? void 0
                    : f.length) &&
                    (t += k.genre.value.exclude
                      .map(function (e, l) {
                        return '&delgenre['.concat(l, ']=del ').concat(e);
                      })
                      .join('')),
                  (t +=
                    '&sortcountchapt=' +
                    ((null === (m = null == k ? void 0 : k.sortcountchapt) ||
                    void 0 === m
                      ? void 0
                      : m.value) || '1')),
                  (t +=
                    '&sortdaycreate=' +
                    ((null === (y = null == k ? void 0 : k.sortdaycreate) ||
                    void 0 === y
                      ? void 0
                      : y.value) || '1')),
                  (t +=
                  ...
                  [
                    4,
                    (0, n.fetchApi)(t).then(function (e) {
                      return e.text();
                    }),
                  ]
                );
              case 1:
                return (
                  ...
                  (o = (0, r.load)(i)),
                  (u = []),
                  o('div[class="block-home"] > div[class="one"]').each(
                    function (e, l) {
                      var a,
                        t = o(l)
                        ...
                        n =
                          null ===
                            ...
                            ? void 0
                            : a.replace('-150x150', ''),
                        i = o(l).find('div[class="img-home"] > a').attr('href');
                      t &&
                        i &&
                        u.push({
                          name: t,
                          cover: n,
                          path: i.replace(x.site, ''),
                        });
                    },
                  ),
                  [2, u]
            ...
            switch (l.label) {
              ...
              case 1:
                return (
                  ...
                  (o = {
                    path: a,
                    name: t('div[class="desc-book"] > h1').text().trim(),
                    cover: t('div[class="img-book"] > img').attr('src'),
                    summary: t('div[id="desc-tab"]').text().trim(),
                    totalPages: t('.sel-toc > option').length,
                  }),
                  t('#info-book > p').each(function () {
                    var e = t(this).text().replace(/,/g, '').split(' ');
                    'Автор:' === e[0]
                      ? (o.author = e.splice(1).join(' '))
                      : 'Жанры:' === e[0]
                        ? (o.genres = e.splice(1).join(','))
                        : 'Статус:' === e[0] &&
                          (o.status = e.includes('продолжается')
                            ? i.NovelStatus.Ongoing
                            : i.NovelStatus.Completed);
                  }),
                  (o.chapters = this.parseChapters(t)),
                  [2, o]
                );
            }
          });
      ...
      (a.prototype.parsePage = function (a, t) {
        return e(this, void 0, void 0, function () {
          var e, i;
          return l(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return (
                  (e = l.sent()),
                  (i = (0, r.load)(e)),
                  [2, { chapters: this.parseChapters(i) }]
                );
            }
          });
        });
      }),
      (a.prototype.parseChapters = function (e) {
        var l = this,
          a = [];
        return (
          e('div.title').each(function (t, n) {
            var i = e(n).find('a').attr('title'),
              r = e(n).find('a').attr('href');
            if (i && r) {
              var o = e(n).find('time').text();
              a.push({
                name: i,
                path: r.replace(l.site, ''),
                releaseTime: l.parseDate(o),
              });
            }
          }),
          a
          ...
          return l(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                return (
                  (e = l.sent()),
                  (t = (0, r.load)(e))('.adblock-service, .lazyblock').remove(),
                  [
                    2,
                    (t('.entry-content').html() || '').replace(
                      /<a[^>]*>(.*?)<\/a>/gi,
                      '$1',
                    ),
                  ]
