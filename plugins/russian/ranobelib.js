var e =
  ...
  l =
    (this && this.__awaiter) ||
    function (e, l, a, t) {
      return new (a || (a = Promise))(function (n, u) {
        function r(e) {
          try {
            o(t.next(e));
          } catch (e) {
...
var n = require('@libs/filterInputs'),
  u = require('@libs/defaultCover'),
  r = require('@libs/fetch'),
  i = require('@libs/novelStatus'),
  o = require('@libs/storage'),
  s = t(require('dayjs')),
  v = {
    1: i.NovelStatus.Ongoing,
    2: i.NovelStatus.Completed,
    3: i.NovelStatus.OnHiatus,
    4: i.NovelStatus.Cancelled,
  },
  c = {
  ...
  b = (function () {
    function t() {
      ...
      (this.id = 'RLIB'),
        ...
        (this.resolveUrl = function (e, a) {
          var t,
            n = (null === (t = l.user) || void 0 === t ? void 0 : t.ui)
              ? 'ui=' + l.user.ui
              : '';
          if (a) return l.site + '/ru/book/' + e + (n ? '?' + n : '');
          var u = e.split('/'),
            r = u[0],
            i = u[1],
            o = u[2],
            s = u[3],
            v = r + '/read/v' + i + '/c' + o + (s ? '?bid=' + s : '');
          return l.site + '/ru/' + v + (n ? (s ? '&' : '?') + n : '');
        }),
        (this.getUser = function () {
          var e,
            l,
            a = o.storage.get('user');
          if (a)
            return { token: { Authorization: 'Bearer ' + a.token }, ui: a.id };
          var t =
            null === (e = o.localStorage.get()) || void 0 === e
              ? void 0
              : e.auth;
          if (!t) return {};
          var n = JSON.parse(t);
          return (
            null === (l = null == n ? void 0 : n.token) || void 0 === l
              ? void 0
              : l.access_token
          )
            ? (o.storage.set(
                'user',
                { id: n.auth.id, token: n.token.access_token },
                n.token.timestamp + n.token.expires_in,
              ),
              {
                token: { Authorization: 'Bearer ' + n.token.access_token },
                ui: n.auth.id,
              })
            : void 0;
        }),
        ...
        (this.filters = {
          ...
          require_chapters: {
            ...
            value: !0,
            type: n.FilterTypes.Switch,
          },
        });
    }
    return (
      (t.prototype.popularNovels = function (e, t) {
        return l(this, arguments, void 0, function (e, l) {
          var t,
            ...
            x,
            S,
            j = l.showLatestNovels,
            C = l.filters;
          return a(this, function (l) {
            switch (l.label) {
              case 0:
                return (
                  (t = this.apiSite + '?site_id[0]=3&page=' + e),
                  (t +=
                    '&sort_by=' +
                    (j
                      ? 'last_chapter_at'
                      : (null === (o = null == C ? void 0 : C.sort_by) ||
                        void 0 === o
                          ? void 0
                          : o.value) || 'rating_score')),
                  (t +=
                    '&sort_type=' +
                    ((null === (s = null == C ? void 0 : C.sort_type) ||
                    void 0 === s
                      ? void 0
                      : s.value) || 'desc')),
                  (null === (v = null == C ? void 0 : C.require_chapters) ||
                  void 0 === v
                    ? void 0
                    : v.value) && (t += '&chapters[min]=1'),
                  (null ===
                    (b =
                      null === (c = null == C ? void 0 : C.types) ||
                      void 0 === c
                        ? void 0
                        : c.value) || void 0 === b
                    ? void 0
                    : b.length) &&
                    (t += '&types[]=' + C.types.value.join('&types[]=')),
                  (null ===
                    (h =
                      null === (d = null == C ? void 0 : C.scanlateStatus) ||
                      void 0 === d
                        ? void 0
                        : d.value) || void 0 === h
                    ? void 0
                    ...
                    (t +=
                      '&scanlateStatus[]=' +
                      C.scanlateStatus.value.join('&scanlateStatus[]=')),
                  (null ===
                    (f =
                      null === (p = null == C ? void 0 : C.manga_status) ||
                      void 0 === p
                        ? void 0
                        : p.value) || void 0 === f
                    ? void 0
                    ...
                    (t +=
                      '&manga_status[]=' +
                      C.manga_status.value.join('&manga_status[]=')),
                  (null == C ? void 0 : C.genres) &&
                    ((null ===
                      (m =
                        null === (g = C.genres.value) || void 0 === g
                          ? void 0
                          : g.include) || void 0 === m
                      ? void 0
                      : m.length) &&
                      (t +=
                        '&genres[]=' +
                        C.genres.value.include.join('&genres[]=')),
                    (null ===
                      (_ =
                        null === (y = C.genres.value) || void 0 === y
                          ? void 0
                          : y.exclude) || void 0 === _
                      ? void 0
                      : _.length) &&
                      (t +=
                        '&genres_exclude[]=' +
                        C.genres.value.exclude.join('&genres_exclude[]='))),
                  (null == C ? void 0 : C.tags) &&
                    ((null ===
                      (w =
                        null === (k = C.tags.value) || void 0 === k
                          ? void 0
                          : k.include) || void 0 === w
                      ? void 0
                      : w.length) &&
                      (t += '&tags[]=' + C.tags.value.include.join('&tags[]=')),
                    (null ===
                      (S =
                        null === (x = C.tags.value) || void 0 === x
                          ? void 0
                          : x.exclude) || void 0 === S
                      ? void 0
                      : S.length) &&
                      (t +=
                        '&tags_exclude[]=' +
                        C.tags.value.exclude.join('&tags_exclude[]='))),
                  [
                    4,
                    (0, r.fetchApi)(t, { headers: this.getHeaders() }).then(
                      function (e) {
                        return e.json();
                      },
                    ),
                ...
                return (
                  ...
                  n.data instanceof Array &&
                    n.data.forEach(function (e) {
                      var l;
                      return i.push({
                        name: e.rus_name || e.eng_name || e.name,
                        cover:
                          (null === (l = e.cover) || void 0 === l
                            ? void 0
                            : l.default) || u.defaultCover,
                        path: e.slug_url || e.id + '--' + e.slug,
                      });
                    }),
                  [2, i]
                );
      ...
      (t.prototype.parseNovel = function (e) {
        return l(this, void 0, void 0, function () {
          var l, t, n, o, c, b, h, p, f, g, m, y, _;
            ...
            switch (a.label) {
              ...
              case 1:
                return (
                  ...
                  (t = {
                    path: e,
                    name: l.rus_name || l.name,
                    cover:
                      (null === (h = l.cover) || void 0 === h
                        ? void 0
                        : h.default) || u.defaultCover,
                    summary:
                      'string' == typeof l.summary
                        ? l.summary.trim()
                        : 'doc' ===
                            (null === (p = l.summary) || void 0 === p
                              ? void 0
                              : p.type)
                          ? d(l.summary.content, [])
                          : void 0,
                  }),
                  (null === (f = l.status) || void 0 === f ? void 0 : f.id) &&
                    (t.status = v[l.status.id] || i.NovelStatus.Unknown),
                  (null === (g = l.authors) || void 0 === g
                    ? void 0
                    : g.length) && (t.author = l.authors[0].name),
                  (null === (m = l.artists) || void 0 === m
                    ? void 0
                    : m.length) && (t.artist = l.artists[0].name),
                  (n = [l.genres || [], l.tags || []]
                    .flat()
                    .map(function (e) {
                    ...
                    .filter(function (e) {
                      return e;
                    })).length && (t.genres = n.join(', ')),
                  (o = (null === (y = l.teams) || void 0 === y
                    ? void 0
                    : y.reduce(
                        function (e, l) {
                          var a,
                  ...
                  [
                    4,
                    (0, r.fetchApi)(
                      ''.concat(this.apiSite).concat(e, '/chapters'),
                      { headers: this.getHeaders() },
                    ).then(function (e) {
                      return e.json();
                    }),
              ...
              case 2:
                return (
                  (c = a.sent()),
                  (null === (_ = c.data) || void 0 === _ ? void 0 : _.length) &&
                    ((b = c.data.flatMap(function (l) {
                      return l.branches.map(function (a) {
                        var t = a.branch_id,
                          n = a.created_at,
                          u = String(null != t ? t : '0');
                        return {
                          name: 'Том '
                            .concat(l.volume, ' Глава ')
                            .concat(l.number)
                            .concat(l.name ? ' ' + l.name.trim() : ''),
                          path: ''
                            .concat(e, '/')
                            .concat(l.volume, '/')
                            .concat(l.number, '/')
                            .concat(u),
                          releaseTime: n
                            ? (0, s.default)(n).format('LLL')
                            : null,
                          chapterNumber: l.index,
                          scanlator: o[u] || 'Неизвестный',
                        };
                      });
                    })),
                    b.length && (t.chapters = b)),
                  [2, t]
                );
            }
          });
      ...
      (t.prototype.parseChapter = function (e) {
        return l(this, void 0, void 0, function () {
          var l, t, n, u, i, o, s, v, c, b, h;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                if (
                  ...
                  throw new Error('Invalid chapter path: '.concat(e));
                return (
                  (o =
                    this.apiSite +
                    t +
                    ...
                    '&volume=' +
                    n),
                  [4, (0, r.fetchApi)(o, { headers: this.getHeaders() })]
                );
              case 1:
                if (!(s = a.sent()).ok)
                  throw new Error(
                    'Could not load chapter (HTTP '.concat(s.status, ')'),
                  );
                return [4, s.json()];
              case 2:
                if (
                  ((v = a.sent()),
                  (c =
                    null === (h = null == v ? void 0 : v.data) || void 0 === h
                      ? void 0
                      : h.content),
                  !(b =
                    'object' == typeof c &&
                    'doc' === (null == c ? void 0 : c.type)
                      ? d(c.content, v.data.attachments || [])
                      : c || ''))
                )
      ...
      (t.prototype.searchNovels = function (e) {
        return l(this, void 0, void 0, function () {
          var l, t, n;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (
                  (l =
                    this.apiSite + '?site_id[0]=3&q=' + encodeURIComponent(e)),
                  [
                    4,
                    (0, r.fetchApi)(l, { headers: this.getHeaders() }).then(
                      function (e) {
                        return e.json();
                      },
                    ),
      ...
      (t.prototype.getHeaders = function () {
        var l,
          a = new URL(this.apiSite);
        return e(
          e(e({}, c), { Host: a.host }),
          (null === (l = this.user) || void 0 === l ? void 0 : l.token) || {},
        );
      }),
      t
    );
      ...
      switch (e.type) {
        ...
        case 'image':
          if (
            null ===
              (n =
                null === (t = e.attrs) || void 0 === t ? void 0 : t.images) ||
            void 0 === n
              ? void 0
              : n.length
          )
            e.attrs.images.forEach(function (e) {
              var t = e.image,
                n = l.find(function (e) {
                  return e.name == t || e.id == t;
                });
              n && (a += "<img src='".concat(n.url, "'>"));
            });
          else if (e.attrs) {
            var u = Object.entries(e.attrs)
              .filter(function (e) {
          ...
          break;
        case 'paragraph':
          a += '<p>' + (e.content ? d(e.content, l) : '<br>') + '</p>';
          break;
        case 'orderedList':
          a += '<ol>' + (e.content ? d(e.content, l) : '<br>') + '</ol>';
          break;
        case 'listItem':
          a += '<li>' + (e.content ? d(e.content, l) : '<br>') + '</li>';
          break;
        case 'blockquote':
          a +=
            '<blockquote>' +
            (e.content ? d(e.content, l) : '<br>') +
            '</blockquote>';
          break;
        case 'italic':
          a += '<i>' + (e.content ? d(e.content, l) : '<br>') + '</i>';
          break;
        case 'bold':
          a += '<b>' + (e.content ? d(e.content, l) : '<br>') + '</b>';
          break;
        case 'underline':
          a += '<u>' + (e.content ? d(e.content, l) : '<br>') + '</u>';
          break;
        case 'heading':
          a += '<h2>' + (e.content ? d(e.content, l) : '<br>') + '</h2>';
          break;
        case 'text':
          a += e.text;
          break;
        default:
          a += JSON.stringify(e, null, '\t');
      }
    }),
    a
  );
