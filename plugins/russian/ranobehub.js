            ...
            for (; t && ((t = 0), n[0] && (b = 0)), b; )
              try {
                if (
                  ...
                  return v;
                switch (((u = 0), v && (n = [2 & n[0], v.value]), n[0])) {
                  case 0:
                  case 1:
                    v = n;
                    break;
                  case 4:
                    return b.label++, { value: n[1], done: !1 };
                  case 5:
                    b.label++, (u = n[1]), (n = [0]);
                    continue;
                  case 7:
                  ...
                  default:
                    ...
                    if (6 === n[0] && b.label < v[1]) {
                      (b.label = v[1]), (v = n);
                      break;
                    }
                    if (v && b.label < v[2]) {
                      (b.label = v[2]), b.ops.push(n);
                      break;
                    }
...
var u = require('@libs/filterInputs'),
  v = require('@libs/fetch'),
  b = require('@libs/novelStatus'),
  t = a(require('dayjs')),
  n = {
    1: b.NovelStatus.Ongoing,
    2: b.NovelStatus.Completed,
    3: b.NovelStatus.OnHiatus,
  },
  i = (function () {
    function a() {
      var l = this;
      (this.id = 'RNBH.org'),
        ...
        (this.filters = {
          ...
          country: {
            ...
            type: u.FilterTypes.CheckboxGroup,
          },
          events: {
            label: 'События',
    ...
    return (
      (a.prototype.popularNovels = function (a, u) {
        return l(this, arguments, void 0, function (l, a) {
          var u,
            ...
            S,
            C,
            w = a.showLatestNovels,
            P = a.filters;
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return (
                  (u = this.site + '/api/search?page=' + l + '&sort='),
                  (u += w
                    ? 'last_chapter_at'
                    : (null === (r = null == P ? void 0 : P.sort) ||
                      void 0 === r
                        ? void 0
                        : r.value) || 'computed_rating'),
                  (u +=
                    '&status=' +
                    ((
                      null === (o = null == P ? void 0 : P.status) ||
                      void 0 === o
                        ? void 0
                        : o.value
                    )
                      ? null === (s = null == P ? void 0 : P.status) ||
                        void 0 === s
                        ? void 0
                        : s.value
                      : '0')),
                  P &&
                    ((null ===
                      (c =
                        null === (d = P.country) || void 0 === d
                          ? void 0
                          : d.value) || void 0 === c
                      ? void 0
                      : c.length) &&
                      (u += '&country=' + P.country.value.join(',')),
                    (b = [
                      null ===
                        (p =
                          null === (h = P.tags) || void 0 === h
                            ? void 0
                            : h.value) || void 0 === p
                        ? void 0
                        : p.include,
                      ...
                      .filter(function (l) {
                        return l;
                      })).length && (u += '&tags:positive=' + b.join(',')),
                    (t = [
                      null ===
                        (y =
                          null === (f = P.tags) || void 0 === f
                            ? void 0
                            : f.value) || void 0 === y
                        ? void 0
                        : y.exclude,
                      ...
                      .filter(function (l) {
                        return l;
                      })).length && (u += '&tags:negative=' + t.join(','))),
                  [
                    4,
                    (0, v.fetchApi)(u + '&take=40').then(function (l) {
                      return l.json();
                    }),
                  ]
                );
              case 1:
                return (
                  ...
                  n.forEach(function (l) {
                    return i.push({
                      name: l.names.rus || l.names.eng || l.names.original,
                      cover: l.poster.medium,
                      path: l.id.toString(),
                    });
                  }),
                  [2, i]
          ...
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return [
                  4,
                  (0, v.fetchApi)(this.site + '/api/ranobe/' + a).then(
                    function (l) {
                      return l.json();
                    },
                  ),
              ...
              case 1:
                return (
                  ...
                  (u = {
                    path: a,
                    name: l.names.rus || l.names.eng || '',
                    cover: l.posters.medium,
                    ...
                    author:
                      (null ===
                        (s =
                          null === (o = null == l ? void 0 : l.authors) ||
                          void 0 === o
                            ? void 0
                            : o[0]) || void 0 === s
                        ? void 0
                        : s.name_eng) || '',
                    status: n[l.status.id] || b.NovelStatus.Unknown,
                  }),
                  (i = [l.tags.events, l.tags.genres]
                    .flat()
                    .map(function (l) {
                      var e, a;
                      return (
                        (null === (e = null == l ? void 0 : l.names) ||
                        void 0 === e
                          ? void 0
                          : e.rus) ||
                        (null === (a = null == l ? void 0 : l.names) ||
                        void 0 === a
                          ? void 0
                          : a.eng) ||
                  ...
                  i.length && (u.genres = i.join(', ')),
                  (r = []),
                  [
                    4,
                    (0, v.fetchApi)(
                      this.site + '/api/ranobe/' + a + '/contents',
                    ).then(function (l) {
                      return l.json();
                    }),
                  ]
              ...
              case 2:
                return (
                  e.sent().volumes.forEach(function (l) {
                    var e;
                    return null === (e = l.chapters) || void 0 === e
                      ? void 0
                      : e.forEach(function (e) {
                          return r.push({
                            name: e.name,
                            path: a + '/' + l.num + '/' + e.num,
                            releaseTime: (0, t.default)(
                              1e3 * parseInt(e.changed_at, 10),
                            ).format('LLL'),
                            chapterNumber: r.length + 1,
                          });
                        });
                  }),
                  (u.chapters = r),
          ...
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return [
                  4,
                  (0, v.fetchApi)(this.resolveUrl(a)).then(function (l) {
                    return l.text();
                  }),
                ];
              case 1:
                return (
                  (l = e.sent()),
                  (u = l.indexOf('<div class="title-wrapper">')),
                  (b = l.indexOf('<div class="ui text container"', u)),
                  [
                    2,
                    l
                      .substring(u, b)
          ...
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return (
                  (l = ''
                    .concat(this.site, '/api/fulltext/global?query=')
                    .concat(a, '&take=10')),
                  [
                    4,
                    (0, v.fetchApi)(l).then(function (l) {
                      return l.json();
                    }),
                  ]
                );
                  ...
                  null ===
                    ...
                    n.forEach(function (l) {
                      ...
                      return b.push({
                        ...
                        path: l.id.toString(),
                        cover:
                          null === (v = null == l ? void 0 : l.image) ||
                          void 0 === v
                            ? void 0
                            : v.replace('/small', '/medium'),
                      });
                    }),
                  [2, b]
                );
