...
var r = require('cheerio'),
  ...
  s = (function () {
    ...
    return (
      (l.prototype.parseDate = function (e) {
        var t = e.split(/,?\s+/),
          a = t[0],
          l = t[1],
          r = t[2];
      ...
      (l.prototype.parseNovels = function (e) {
        var t = this,
          a = [];
        return (
          e('.listupd .bsx').each(function (l, r) {
            var n = e(r).find('.tt').text().trim(),
              o = e(r).find('a').attr('href'),
              u = e(r).find('img').attr('src');
            if (o) {
              var s = {
                name: n,
                cover: u || i.defaultCover,
      ...
      (l.prototype.popularNovels = function (e, l) {
        return t(this, arguments, void 0, function (e, t) {
          var l,
            i,
            o,
            u,
            s = t.showLatestNovels,
            c = t.filters;
            ...
            switch (t.label) {
              case 0:
                return (
                  ...
                  e > 1 && l.append('page', ''.concat(e)),
                  l.append('type', 'novel'),
                  s
                    ? l.append('order', 'latest')
                    : c &&
                      (c.genre.value.length &&
                        c.genre.value.forEach(function (e) {
                          l.append('genre[]', e);
                        }),
                      l.append('order', c.order.value)),
                  (i = ''.concat(this.site, '/manga/?') + l.toString()),
                  [
                    4,
              ...
              case 1:
                return (
                  (o = t.sent()), (u = (0, r.load)(o)), [2, this.parseNovels(u)]
                );
            }
          });
        });
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [
                  4,
                  (0, n.fetchApi)(this.site + l).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                return (
                  ...
                  ((o = {
                    path: l,
                    name: i('h1.entry-title').text() || 'Untitled',
                    cover: i('.main-info .thumb img').attr('src'),
                    summary: i('.entry-content.entry-content-single div:eq(0)')
                      .text()
                      .trim(),
                    chapters: [],
                  }).author = i('.tsinfo .imptdt:contains("Autor")')
                    .text()
                    .replace('Autor ', '')
                    .trim()),
                  (o.artist = i('.tsinfo .imptdt:contains("Artista")')
                    .text()
                    .replace('Artista ', '')
                    .trim()),
                  (o.status = i('.tsinfo .imptdt:contains("Status")')
                    .text()
                    .replace('Status ', '')
                    .trim()),
                  (o.genres = i('.mgen a')
                    ...
                    .join(',')),
                  (u = []),
                  i('#chapterlist ul > li').each(function (e, t) {
                    var a = i(t).find('.chapternum').text().trim(),
                      l = i(t).find('a').attr('href'),
                      r = i(t).find('.chapterdate').text();
                    l &&
                      u.push({
                        name: a,
                        path: l.replace(s.site, ''),
                        releaseTime: s.parseDate(r),
                      });
                  }),
                  (o.chapters = u.reverse().map(function (t, a) {
                    return e(e({}, t), {
                      name: t.name + ' - Ch. '.concat(a + 1),
                      chapterNumber: a + 1,
                    });
                  })),
                  [2, o]
      ...
      (l.prototype.searchNovels = function (e, l) {
        return t(this, void 0, void 0, function () {
          var t, i, o, u;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (
                  ...
                  l > 1 && t.append('page', ''.concat(l)),
                  t.append('type', 'novel'),
                  t.append('title', e),
                  (i = ''.concat(this.site, '/manga/?') + t.toString()),
                  [
                    4,
                    (0, n.fetchApi)(i).then(function (e) {
                      return e.text();
              ...
              case 1:
                return (
                  (o = a.sent()), (u = (0, r.load)(o)), [2, this.parseNovels(u)]
                );
            }
          });
        });
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [
                  4,
                  (0, n.fetchApi)(this.site + e).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                return (
                  (t = a.sent()),
                  (l = (0, r.load)(t)),
                  (i = l('.headpost .entry-title').text()),
                  (o = l('.headpost a').text()),
                  (u = i.replace(o, '').replace(/^\W+/, '').trim()),
                  (s = l('#readerarea .collapseomatic_content').html())
                    ? [2, '<h1>'.concat(u, '</h1>\n').concat(s)]
                    : ((c = l('#readerarea'))
                        .find('img.wp-image-15656')
                        .remove(),
                      c.find('p').each(function (e, t) {
                        var a,
                          r,
                          n = l(t),
                          i = n.find('img'),
                          o =
                            null ===
                              (r =
                                null === (a = n.text()) || void 0 === a
                                  ? void 0
                                  : a.replace(/\s|&nbsp;/g, '')) || void 0 === r
                              ? void 0
                              : r.replace(b.site, '');
                      ...
                      (v = p.split(/<hr ?\/?>/)),
                      (h = v[v.length - 1]),
                      v.length > 1 && h.includes('https://discord') && v.pop(),
                      [2, '<h1>'.concat(u, '</h1>\n').concat(v.join('<hr />'))])
                );
            }
          });
