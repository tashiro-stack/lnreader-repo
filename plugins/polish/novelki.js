        ...
        return e(this, arguments, void 0, function (e, l) {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return (
                  (r = this.site + '/projekty?filter=t'),
                  (r += '&genre=' + (null == c ? void 0 : c.genres.value)),
                  (r += '&status=' + (null == c ? void 0 : c.status.value)),
                  (r += '&type=' + (null == c ? void 0 : c.type.value)),
                  (r += '&page=' + e),
                  [
                    4,
                    (0, a.fetchApi)(r).then(function (e) {
                      if (e.url == ''.concat(s.site, '/guest'))
                        throw new Error(
                          'Failed to load novels (open in web view and login)',
                        );
                      return e.text();
                    }),
                  ]
                ...
                return (
                  ...
                  [
                    ...
                    u
                      .map(function (e, t) {
                        return {
                          name: o(t).find('.card-title').attr('title'),
                          cover:
                            s.site + o(t).find('.card-img-top').attr('src'),
                          path: o(t).find('a').attr('href') || '',
                        };
                      })
                      .get()
                      .filter(function (e) {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [
                  4,
                  (0, a.fetchApi)(this.site + l).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                return (
                  ...
                  (i = (0, n.load)(e)),
                  (o = { path: l, name: '' }),
                  i('p.h5').each(function (e, t) {
                    var a = i(t).text().trim();
                    if (
                      (a.includes('Autor:') &&
                        (o.author = a.split(':')[1].trim()),
                      a.includes('Status projektu:'))
                    )
                      switch (''.concat(a.split(':')[1].trim()).toLowerCase()) {
                        case 'wstrzymany':
                  ...
                  (o.name = i('div.col-sm-12.col-md-6.col-lg-8.mb-5')
                    .find('h3')
                    .text()
                    .trim()),
                  (o.cover = this.site + i('.img-fluid').attr('src')),
                  (o.genres = i('span.badge')
                    .map(function (e, t) {
                      return i(t).text();
                    })
                    .get()
                    .join(', ')),
                  (o.summary = i('.h5:contains("Opis:")')
                    .next('p')
                    .next('p')
                    .text()
                    .trim()),
                  (u = []),
                  (s = i('.chapters > .col-md-3 > div').get()).forEach(
                    function (e, t) {
                      var a,
                        l = i(e).find('a').attr('href') || '',
                        n = {
                          name:
                            null === (a = i(e).find('a')) || void 0 === a
                              ? void 0
                              : a.text().trim(),
                          path: l,
                          releaseTime: i(e)
                            ...
                            .reverse()
                            .join('-'),
                          chapterNumber: s.length - t,
                        };
                      u.push(n);
                    },
                  ),
                  (o.chapters = u.reverse()),
                  [2, o]
                );
            }
          });
        ...
        return e(this, void 0, void 0, function () {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return (
                  ...
                  [
                    ...
                    (0, a.fetchApi)(
                      ''
                        .concat(this.site, '/api/reader/chapters/')
                        .concat(e[2]),
                    ).then(function (e) {
                      if (e.url == ''.concat(r.site, '/guest'))
                        throw new Error(
                          'Failed to load chapter (open in web view and login)',
                        );
                      return e.json();
                    }),
                  ]
              ...
              case 1:
                return (n = t.sent()), [2, n.data.content];
            }
          });
        });
      }),
      (i.prototype.searchNovels = function (l, r) {
        return e(this, void 0, void 0, function () {
          var e,
            i,
            o = this;
            ...
            switch (t.label) {
              case 0:
                return [
                  ...
                  (0, a.fetchApi)(
                    ''
                      .concat(this.site, '/projekty?filter=t&title=')
                      .concat(l, '+&page=')
                      .concat(r),
                  ).then(function (e) {
                    if (e.url == ''.concat(o.site, '/guest'))
                      throw new Error(
                        'Failed to search novels (open in web view and login)',
                      );
                    return e.text();
                  }),
                ];
                ...
                return (
                  ...
                  [
                    ...
                    i('#projects > div')
                      .map(function (e, t) {
                        return {
                          name: i(t).find('.card-title').attr('title'),
                          cover:
                            o.site + i(t).find('.card-img-top').attr('src'),
                          path: i(t).find('a').attr('href') || '',
                        };
                      })
                      .get()
                      .filter(function (e) {
