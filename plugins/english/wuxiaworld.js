...
var r = (function () {
  ...
  return (
    (r.prototype.parseNovels = function (e) {
      ...
      return (
        e.items.map(function (e) {
          var t = e.name,
            o = e.coverUrl,
            a = 'novel/'.concat(e.slug, '/');
          n.push({ name: t, cover: o, path: a });
        }),
        n
      );
    }),
    (r.prototype.popularNovels = function () {
      return e(this, void 0, void 0, function () {
        ...
        return n(this, function (n) {
          switch (n.label) {
            case 0:
              return (
                (e = ''.concat(this.site, 'api/novels')),
                [4, (0, a.fetchApi)(e)]
              );
            case 1:
              return [4, n.sent().json()];
            case 2:
              return (t = n.sent()), [2, this.parseNovels(t)];
          }
        });
      });
    }),
    (r.prototype.parseNovel = function (r) {
      return e(this, void 0, void 0, function () {
        var e, s, l, p, u, h, c, v, d, m, f, g, C, b, y, w, I, N, G, S, V, R, T;
        return n(this, function (n) {
          switch (n.label) {
            case 0:
              return [
            ...
            case 1:
              switch (
                ...
                (s = {
                  path: r,
                  name:
                    (null === (h = e.item) || void 0 === h ? void 0 : h.name) ||
                    'Untitled',
                  cover:
                    null ===
                      (v =
                        null === (c = e.item) || void 0 === c
                          ? void 0
                          : c.coverUrl) || void 0 === v
                      ? void 0
                      : v.value,
                  summary: (0, o.load)(
                    (null ===
                      (m =
                        null === (d = e.item) || void 0 === d
                          ? void 0
                          : d.description) || void 0 === m
                      ? void 0
                      : m.value) +
                      '\n\n' +
                      (null ===
                        (g =
                          null === (f = e.item) || void 0 === f
                            ? void 0
                            : f.synopsis) || void 0 === g
                        ? void 0
                        : g.value),
                ...
                null === (w = e.item) || void 0 === w ? void 0 : w.status)
              ) {
                case t.Active:
                ...
                (0, a.fetchProto)(
                  {
                    ...
                    requestData: {
                      novelId:
                        null === (I = e.item) || void 0 === I ? void 0 : I.id,
                    },
                  },
                        ...
                        null ===
                          (G =
                            null === (N = e.item) || void 0 === N
                              ? void 0
                              : N.karmaInfo) || void 0 === G
                          ? void 0
                          : G.maxFreeChapter) || void 0 === S
                      ? void 0
                      : S.units,
                  ) +
                    ((null ===
                      (T =
                        null ===
                          (R =
                            null === (V = e.item) || void 0 === V
                              ? void 0
                              : V.karmaInfo) || void 0 === R
                          ? void 0
                          : R.maxFreeChapter) || void 0 === T
                      ? void 0
                      : T.nanos) || 0) /
                      1e9 || 50),
                (u = l.items.flatMap(function (e) {
                  return e.chapterList.map(function (n) {
                    var t, o, a, i, s, l;
                    return {
                      page: e.title,
                      name:
                        ...
                        (!1 ===
                          (null ===
                            (o =
                              null === (t = n.relatedUserInfo) || void 0 === t
                                ? void 0
                                : t.isChapterUnlocked) || void 0 === o
                            ? void 0
                            : o.value) ||
                        (!n.relatedUserInfo &&
                          Number(
                            null === (a = n.number) || void 0 === a
                              ? void 0
                              : a.units,
                          ) +
                            ((null === (i = n.number) || void 0 === i
                              ? void 0
                              : i.nanos) || 0) /
                              1e9 >
                            p)
                          ...
                          : ''),
                      path: r + n.slug,
                      chapterNumber: n.offset,
                      releaseTime: new Date(
                        1e3 *
                          ((null === (s = n.publishedAt) || void 0 === s
                            ? void 0
                            : s.seconds) || 0) +
                          ((null === (l = n.publishedAt) || void 0 === l
                            ? void 0
                            : l.nanos) || 0) /
                            1e6,
                      ).toISOString(),
    ...
    (r.prototype.parseChapter = function (t) {
      return e(this, void 0, void 0, function () {
        var e, o, i, r;
        return n(this, function (n) {
          switch (n.label) {
                  ...
                  (0, a.fetchProto)(
                    {
                      ...
                      requestData: {
                        chapterProperty: {
                          slugs: { novelSlug: e[1], chapterSlug: e[2] },
                        },
                      },
                    },
    ...
    (r.prototype.searchNovels = function (t) {
      return e(this, void 0, void 0, function () {
        var e, o;
        return n(this, function (n) {
          switch (n.label) {
