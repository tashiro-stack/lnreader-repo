  ...
  t =
    ...
    function (e, l, a) {
      if (a || 2 === arguments.length)
        for (var t, r = 0, u = l.length; r < u; r++)
          (!t && r in l) ||
            (t || (t = Array.prototype.slice.call(l, 0, r)), (t[r] = l[r]));
      return e.concat(t || Array.prototype.slice.call(l));
    };
Object.defineProperty(exports, '__esModule', { value: !0 });
var r = require('@libs/fetch'),
  u = require('@libs/filterInputs'),
  i = require('cheerio'),
  n = require('@libs/aes'),
  o = (function () {
    function o() {
      (this.id = 'WTRLAB'),
        ...
        (this.trace = ''),
        (this.filters = {
          search: { value: '', label: 'Search', type: u.FilterTypes.TextInput },
          orderBy: {
            value: 'update',
            label: 'Order by',
            options: [
          ...
          genres: {
            label: 'Genres',
            type: u.FilterTypes.ExcludableCheckboxGroup,
    ...
    return (
      Object.defineProperty(o.prototype, 'headers', {
        get: function () {
          return { baggage: this.baggage, 'sentry-trace': this.trace };
        },
        enumerable: !1,
        configurable: !0,
      }),
      (o.prototype.popularNovels = function (e, t) {
        return l(this, arguments, void 0, function (e, l) {
          ...
          return a(this, function (l) {
            switch (l.label) {
              case 0:
                return (
                  (t = this.site + this.sourceLang + 'novel-list?'),
                  (u = new URLSearchParams()).append(
                    'orderBy',
                    S.orderBy.value,
                  ),
                  u.append('order', S.order.value),
                  u.append('status', S.status.value),
                  u.append('release_status', S.release_status.value),
                  u.append('addition_age', S.addition_age.value),
                  u.append('page', e.toString()),
                  S.search.value && u.append('text', S.search.value),
                  (null === (p = S.genres.value) || void 0 === p
                    ? void 0
                    : p.include) &&
                    S.genres.value.include.length > 0 &&
                    (u.append('gi', S.genres.value.include.join(',')),
                    u.append('gc', S.genre_operator.value)),
                  (null === (g = S.genres.value) || void 0 === g
                    ? void 0
                    : g.exclude) &&
                    S.genres.value.exclude.length > 0 &&
                    u.append('ge', S.genres.value.exclude.join(',')),
                  (null === (h = S.tags.value) || void 0 === h
                    ? void 0
                    : h.include) &&
                    S.tags.value.include.length > 0 &&
                    (u.append('ti', S.tags.value.include.join(',')),
                    u.append('tc', S.tag_operator.value)),
                  (null === (m = S.tags.value) || void 0 === m
                    ? void 0
                    : m.exclude) &&
                    S.tags.value.exclude.length > 0 &&
                    u.append('te', S.tags.value.exclude.join(',')),
                  S.folders.value && u.append('folders', S.folders.value),
                  S.library_exclude.value &&
                    u.append('le', S.library_exclude.value),
                  S.min_chapters.value &&
                    u.append('count_value', S.min_chapters.value),
                  S.min_rating.value && u.append('minr', S.min_rating.value),
                  S.min_review_count.value &&
                    u.append('minrc', S.min_review_count.value),
                  f
                    ? [
                        4,
                        (0, r.fetchApi)(this.site + 'api/home/recent', {
                          method: 'POST',
              ...
              case 3:
                return [
                  4,
                  (0, r.fetchApi)(this.site + 'en/novel-finder').then(
                    function (e) {
                      return e.text();
                    },
                  ),
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [
                  4,
                  (0, r.fetchApi)(this.site + this.sourceLang).then(
                    function (e) {
                      return e.text();
                    },
                  ),
              ...
              case 1:
                return (
                  ...
                  (l = (0, i.load)(e)),
                  (this.baggage =
                    null !== (t = l('meta[name="baggage"]').attr('content')) &&
                    void 0 !== t
                      ? t
                      : ''),
                  (this.trace =
                    null !==
                      (u = l('meta[name="sentry-trace"]').attr('content')) &&
                    void 0 !== u
                      ? u
                      : ''),
                  [2]
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [
                  4,
                  (0, r.fetchApi)(this.site + e).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                return (
                  (l = a.sent()),
                  (u = (0, i.load)(l)),
                  (n = u('meta[name="baggage"]').attr('content')),
                  (o = u('meta[name="sentry-trace"]').attr('content')),
                  n && o
                    ? ((this.baggage = n), (this.trace = o), [3, 4])
                    : [3, 2]
                );
              case 2:
              ...
              case 4:
                if (
                  ...
                  (p = {
                    path: e,
                    name: u('h1.text-uppercase').text(),
                    summary: u('.lead').text().trim(),
                  }),
                  v)
                )
                  try {
                      ...
                      (g =
                        null ===
                          (L =
                            null ===
                              (F =
                                null === (x = null == w ? void 0 : w.props) ||
                                void 0 === x
                                  ? void 0
                                  : x.pageProps) || void 0 === F
                              ? void 0
                              : F.serie) || void 0 === L
                          ? void 0
                          : L.serie_data))
                      ...
                      switch (
                        ...
                        (p.cover =
                          (null === (_ = g.data) || void 0 === _
                            ...
                            : _.image) || ''),
                        (p.summary =
                          (null === (k = g.data) || void 0 === k
                            ? void 0
                            : k.description) || ''),
                        (p.author =
                          (null === (R = g.data) || void 0 === R
                            ? void 0
                            : R.author) || ''),
                        (b = g.raw_id || null),
                        (c = g.slug || null),
                ...
                if (
                  (p.name ||
                    (p.name =
                      u('h1.text-uppercase').text() ||
                      u('h1.long-title').text() ||
                      u('.title-wrap h1').text().trim()),
                  p.cover ||
                    (p.cover =
                      u('.image-wrap img').attr('src') ||
                      u('.img-wrap > img').attr('src')),
                  p.summary ||
                    (p.summary =
                      u('.description').text().trim() ||
                      u('.desc-wrap .description').text().trim() ||
                      u('.lead').text().trim()),
                  (h =
                    u('td:contains("Genre")')
                      .next()
                  ...
                  (m =
                    ...
                    u('.tags .tag')
                      ...
                      .toArray()).length > 0 &&
                    ((y = p.genres ? p.genres.split(', ') : []),
                    (f = t(t([], y, !0), m, !0).filter(function (e) {
                      return e && e.length > 0;
                    })),
                    (S = f.filter(function (e, l) {
                      return f.indexOf(e) === l;
                    })),
                    (p.genres = S.join(', '))),
                  p.author ||
                    (p.author =
                      u('td:contains("Author")')
                        .next()
                        .text()
                        .replace(/[\t\n]/g, '')
                        .trim() ||
                      u('td:contains("Author") + td')
                        .text()
                        .replace(/[\t\n]/g, '')
                        .trim()),
                  p.status ||
                    (p.status =
                      u('td:contains("Status")')
                        .next()
                        .text()
                        .replace(/[\t\n]/g, '')
                        .trim() ||
                      u('td:contains("Status") + td')
                        .text()
                        .replace(/[\t\n]/g, '')
                        .trim() ||
                      (null ===
                        (B = u('.detail-line:contains("•")')
                          .text()
                          .match(/•\s*(\w+)/)) || void 0 === B
                        ? void 0
                        : B[1]) ||
                      ''),
                  (P = e.match(/(?:serie|novel)-?(\d+)\/([^/]+)/)) &&
                    ((b = parseInt(P[1])), (c = P[2])),
                  (A =
                    u('.detail-line:contains("Chapters")').text() ||
                    u('div:contains("Chapters")').text()),
                  (C = A.match(/(\d+)\s+Chapters?/i)) && (d = parseInt(C[1])),
                  0 === d && v)
                )
                  try {
                    (w = JSON.parse(v)),
                                ...
                                null ===
                                  (I =
                                    null ===
                                      (O =
                                        null ===
                                          (G = null == w ? void 0 : w.props) ||
                                        void 0 === G
                                          ? void 0
                                          : G.pageProps) || void 0 === O
                                      ? void 0
                                      : O.serie) || void 0 === I
                                  ? void 0
                                  : I.serie_data) || void 0 === E
                              ? void 0
                              : E.chapter_count) && void 0 !== H
                          ? H
                          : 0);
                  } catch (e) {
                    console.error(
              ...
              case 5:
                return (
                  a.trys.push([5, 7, , 8]), [4, this.fetchAllChapters(b, c)]
                );
              case 6:
                return (T = a.sent()), [3, 8];
              case 7:
                return (
                  (M = a.sent()),
                  console.error('Failed to fetch chapters via API:', M),
                  (T = []),
                  [3, 8]
                );
              case 8:
            ...
            switch (a.label) {
              case 0:
                for (
                  ...
                  (v = s[o]),
                    (d = e(v).attr('src')) && (t.includes(d) || t.push(d));
                (b = 0), (c = t), (a.label = 1);
              case 1:
                return b < c.length
                  ? ((d = c[b]),
                    [4, (0, r.fetchApi)(''.concat(this.site).concat(d))])
                  : [3, 5];
              case 2:
                return [4, a.sent().text()];
              case 3:
                if (((p = a.sent()), (i = p.indexOf(l)) >= 0))
                  return (u = p), [3, 5];
                a.label = 4;
              case 4:
                return b++, [3, 1];
              case 5:
                if (!u) throw new Error('Failed to find Encryption Key');
                return [2, u.substring(i + 22, i + 54)];
            }
          });
        });
      }),
        ...
        return l(this, void 0, void 0, function () {
          ...
          return a(this, function (a) {
            switch (a.label) {
              ...
              case 2:
                return (t = a.sent()), [2, t && t[0] ? t[0] : []];
            }
          });
        });
      }),
      (o.prototype.parseChapter = function (e) {
        return l(this, void 0, void 0, function () {
          var l,
            t,
            u,
            ...
            switch (a.label) {
              case 0:
                return (
                  ...
                  )) && ((t = parseInt(o[1], 10)), (u = parseInt(o[2], 10))),
                  t && u
                    ? [3, 2]
                    : [
                        4,
                        (0, r.fetchApi)(l).then(function (e) {
                          return e.text();
                        }),
                      ]
                );
              case 1:
                (P = a.sent()),
                  (n = (0, i.load)(P)),
                  (s = n('#__NEXT_DATA__').html() + ''),
                  (v = JSON.parse(s)),
                  (t = v.props.pageProps.serie.chapter.raw_id),
                  (u = v.props.pageProps.serie.chapter.order),
                  (a.label = 2);
              case 2:
                if (!t || !u)
                  throw (
                    ((m = "Missing required parameters for API call from URL '"
                      .concat(e, "' - rawId: ")
                      .concat(t, ', chapterNo: ')
                      .concat(u, '. Please check the URL format.')),
                    console.error(m),
                    new Error(m))
                  );
                (b = ''), (d = 0), (p = ['ai', 'web']), (a.label = 3);
              case 3:
                return d < p.length
                  ? ((g = p[d]),
                    [
                      4,
                      (0, r.fetchApi)(''.concat(this.site, 'api/reader/get'), {
                        method: 'POST',
                        headers: {
              ...
              case 7:
                if (0 == c.success)
                  throw ((m = c.message), console.error(m), new Error(m));
                return (
                  (y = c.data.data.body),
                  (f =
                    null ===
                      (F =
                        null === (x = null == c ? void 0 : c.data) ||
                        void 0 === x
                          ? void 0
                          : x.data) || void 0 === F
                      ? void 0
                      : F.glossary_data),
                  (S = ''),
                  y.toString().startsWith('arr:') ||
                  y.toString().startsWith('str:')
                    ? n
                      ? [3, 9]
                      : [
                          4,
              ...
              case 8:
                (P = a.sent()), (n = (0, i.load)(P)), (a.label = 9);
              case 9:
                return [4, this.getKey(n)];
              case 10:
                return (A = a.sent()), [4, this.decrypt(y, A)];
              case 11:
                return (
                  (y = a.sent()),
                  Object.prototype.hasOwnProperty.call(y, 'error')
                    ? [2, (S += '<p>'.concat(y.error.toString(), '</p>'))]
                    : [4, this.translate(y)]
                );
              case 12:
                (y = a.sent()),
                  (S +=
                    "<p><small>This is being translated from your device via google translate (source's method) - Login via web view to try for ai translations</small></p>"),
                  (a.label = 13);
              case 13:
                for (
                  '' !== b &&
                    (S += '<p style="color:darkred;">'.concat(b, '</p>')),
                    C =
                      (null === (L = null == f ? void 0 : f.terms) ||
                      void 0 === L
                        ? void 0
                        : L.map(function (e) {
                            return e[0];
      ...
      (o.prototype.fetchAllChapters = function (t, u) {
        return l(this, void 0, void 0, function () {
          var l,
            i,
            n,
            ...
            switch (a.label) {
              ...
              case 5:
                return (
                  (d = a.sent()),
                  console.error(
                    'Failed to fetch chapters '.concat(n, '-').concat(s, ':'),
                    d,
                  ),
                  (o = !1),
                  [3, 7]
