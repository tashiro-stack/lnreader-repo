...
function s(e) {
  return e
    .replace(/\\x([0-9a-fA-F]{2})/g, function (e, a) {
      return String.fromCharCode(parseInt(a, 16));
    })
    .replace(/\\u([0-9a-fA-F]{4})/g, function (e, a) {
      return String.fromCharCode(parseInt(a, 16));
    })
    .replace(/\\"/g, '"')
    .replace(/\\n/g, '\n')
...
function f(e) {
  ...
  a
    ...
    .replace(/&#x([0-9a-fA-F]+);/g, function (e, a) {
      return String.fromCharCode(parseInt(a, 16));
    })
    .replace(/&amp;/g, '&')
    .replace(/&lt;/g, '<')
...
var p = (function () {
  ...
  return (
    (c.prototype.popularNovels = function (t, c) {
      return e(this, arguments, void 0, function (e, t) {
        ...
        return a(this, function (a) {
          switch (a.label) {
            case 0:
              return (
                (c = new URLSearchParams()).set('page', String(e)),
                (o = null == b ? void 0 : b.genres.value) &&
                  u[o] &&
                  c.append('categories[]', u[o]),
                (d = null == b ? void 0 : b.status.value) &&
                  c.append('statuses[]', d),
                (s = null == b ? void 0 : b.type.value) &&
                  c.append('nationalities[]', s),
                [
                  4,
                  (0, l.fetchApi)(''.concat(n, '/novels?').concat(c), {
                    headers: i,
                  }).then(function (e) {
                    return e.json();
                  }),
                    ...
                    function (e) {
                      ...
                      return {
                        ...
                        cover:
                          null !==
                            (l =
                              null === (a = e.cover) || void 0 === a
                                ? void 0
                                : a.large) && void 0 !== l
                            ? l
                            : r.defaultCover,
                        path: '/novels/'.concat(e.slug),
                      };
                    },
                  ),
                ]
    ...
    (c.prototype.parseNovel = function (t) {
      return e(this, void 0, void 0, function () {
        var e, c, o, u, s, p, b, v, g, h, m, y, M, A, x, C, w;
        return a(this, function (a) {
          switch (a.label) {
            case 0:
              return (
                ...
                [
                  4,
                  (0, l.fetchApi)(''.concat(n, '/novels/').concat(e), {
                    headers: i,
                  }).then(function (e) {
                    return e.json();
                  }),
            ...
            case 3:
              if (
                ((b = a.sent()),
                (v = null !== (y = b.data) && void 0 !== y ? y : []).length)
              ) {
                for (g = 0, h = v; g < h.length; g++)
                  (m = h[g]),
                    u.push({
                      name: m.longTitle || m.title || m.slug,
                      path: '/novels/'.concat(e, '/capitulos/').concat(m.slug),
                    });
                v.length < 20 ? (p = !1) : s++;
              } else p = !1;
              return [3, 2];
              ...
              return [
                2,
                {
                  ...
                  cover:
                    null !==
                      (A =
                        null === (M = o.cover) || void 0 === M
                          ? void 0
                          : M.large) && void 0 !== A
                      ? A
                      : r.defaultCover,
                  summary: f(
                    null !== (x = o.synopsis) && void 0 !== x ? x : '',
                  ),
                  author: null !== (C = o.author) && void 0 !== C ? C : '',
                  genres: (null !== (w = o.categories) && void 0 !== w ? w : [])
                    .map(function (e) {
                      return e.name;
                    })
                    .join(','),
        ...
        return a(this, function (a) {
          switch (a.label) {
            case 0:
              return [
                4,
                (0, l.fetchApi)(''.concat(o).concat(t)).then(function (e) {
                  return e.text();
                }),
              ];
            case 1:
              if (
                ((e = a.sent()),
                (r = e.match(/[,{]content:"((?:[^"\\]|\\.)*)"/)),
                (c = (null == r ? void 0 : r[1]) ? s(r[1]) : ''),
                (n = e.match(
                  /updatedAt:"[^"]+",title:"((?:[^"\\]|\\.)*)",slug:/,
                )),
                (i = (null == n ? void 0 : n[1]) ? s(n[1]) : ''),
                (u = e.match(/longTitle:"((?:[^"\\]|\\.)*)"/)),
                (d = (null == u ? void 0 : u[1]) ? s(u[1]) : ''),
                (f =
                  null !==
                    (N =
                      null === (w = d.split(/\s*[\u2013-]\s*/)[0]) ||
                      void 0 === w
                        ? void 0
                        : w.trim()) && void 0 !== N
                    ? N
                ...
                (p = ''),
                d ||
                  ((null == (b = e.match(/og:title[^>]*content="([^"]+)"/))
                    ? void 0
                    : b[1]) &&
                    (v = b[1].split(/\s*[\u2013-]\s*/)).length >= 2 &&
                    ((f =
                      null !==
                        (j =
                          null === (T = v[0]) || void 0 === T
                ...
                for (
                  ...
                  (x = s(A[1])) && !h.includes(x) && h.push(x);
              return (
                (C = []),
                f &&
                  C.push(
                    '<p style="text-transform:uppercase;font-weight:bold;font-size:0.8em;letter-spacing:0.08em;margin:0 0 6px 0;opacity:0.7">' +
                      f +
                      '</p>',
                  ),
                g &&
    ...
    (c.prototype.searchNovels = function (t, c) {
      return e(this, void 0, void 0, function () {
        var e, o, u;
        return a(this, function (a) {
          switch (a.label) {
