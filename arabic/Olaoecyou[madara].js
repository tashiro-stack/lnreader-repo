var e =
    (this && this.__awaiter) ||
    function (e, a, l, t) {
      return new (l || (l = Promise))(function (r, n) {
        function u(e) {
          try {
            o(t.next(e));
          } catch (e) {
...
var t = require('@libs/fetch'),
  ...
  v = (function () {
    function l(e) {
      ...
      (this.hideLocked = o.storage.get('hideLocked')),
        (this.parseData = function (e) {
          ...
          if (s(e, ['detik', 'segundo', 'second', 'วินาที']))
            ...
            l = l.subtract(r, 'days');
          else if (s(e, ['week', 'semana'])) l = l.subtract(r, 'week');
          else if (s(e, ['month', 'mes'])) l = l.subtract(r, 'month');
          else {
            if (!s(e, ['year', 'año']))
              return 'Invalid Date' !== (0, i.default)(e).format('LL')
                ? (0, i.default)(e).format('LL')
                : e;
            l = l.subtract(r, 'year');
          }
          return l.format('LL');
      ...
      (this.version = '2.2.'.concat(t)),
        (this.options = e.options),
        (this.filters = e.filters),
        (null === (l = this.options) || void 0 === l ? void 0 : l.hasLocked) &&
          (this.pluginSettings = {
            hideLocked: {
              value: '',
    ...
    return (
      (l.prototype.translateDragontea = function (e) {
        var a;
            ...
            .each(function (e, a) {
              var t = l(a),
                r = t
                  ...
                  .join('');
              t.replaceWith(r.replace('\n', '<br>'));
            }),
          e
        );
      }),
      (l.prototype.getHostname = function (e) {
        var a = (e = e.split('/')[2]).split('.');
        return a.pop(), a.join('.');
      }),
      (l.prototype.getCheerio = function (l, n) {
        return e(this, void 0, void 0, function () {
          var e, u, i, o;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, (0, t.fetchApi)(l)];
              case 1:
                if (!(e = a.sent()).ok && 1 != n)
                  throw new Error(
                ...
                return (i = r.load), [4, e.text()];
              case 2:
                if (
                  ((u = i.apply(void 0, [a.sent()])),
                  (o = u('title').text().trim()),
                  this.getHostname(l) != this.getHostname(e.url) ||
                    'Bot Verification' == o ||
      ...
      (l.prototype.parseNovels = function (e) {
        var a = [];
        return (
          e('.manga-title-badges').remove(),
          e('.page-item-detail, .c-tabs-item__content').each(function (l, t) {
            var r = e(t).find('.post-title').text().trim(),
              u = e(t).find('.post-title').find('a').attr('href') || '';
            if (r && u) {
              var i = e(t).find('img'),
                o = {
                  name: r,
      ...
      (l.prototype.popularNovels = function (l, t) {
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                ...
                s || (s = this.filters || {}),
                v && (t += '&m_orderby=latest'),
                s))
                  if ('object' == typeof s[r].value)
                    for (n = 0, u = s[r].value; n < u.length; n++)
                      (i = u[n]), (t += '&'.concat(r, '=').concat(i));
                  else
                    s[r].value && (t += '&'.concat(r, '=').concat(s[r].value));
                return [4, this.getCheerio(t, 1 != e)];
              case 1:
                return (o = a.sent()), [2, this.parseNovels(o)];
            }
          });
        });
      }),
      (l.prototype.parseNovel = function (l) {
        return e(this, void 0, void 0, function () {
          var e,
            o,
            s,
          ...
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, this.getCheerio(this.site + l, !1)];
              case 1:
                return (
                  (e = a.sent())(
                  ...
                  e('.post-content_item, .post-content').each(function () {
                    ...
                    switch (a) {
                      ...
                      case 'Durum':
                        o.status =
                          l.text().trim().includes('OnGoing') ||
                          l.text().trim().includes('مستمرة')
                            ? u.NovelStatus.Ongoing
                            : u.NovelStatus.Completed;
                        break;
                      case 'Artist(s)':
                        o.artist = l.text().trim();
                    }
                  }),
                  ...
                  (
                    ...
                    ? [
                        4,
                        (0, t.fetchApi)(this.site + l + 'ajax/chapters/', {
                          method: 'POST',
                          referrer: this.site + l,
                        }).then(function (e) {
                          return e.text();
                        }),
                      ]
              ...
              case 2:
                if (
                  ((v = a.sent()),
                  (c = (0, r.load)(v)),
                  !((b = c('.pagination a[data-page]')).length > 0))
                )
                  return [3, 6];
                if (
                  ((p = Math.max.apply(
                    ...
                    b
                      .map(function (e, a) {
                        return parseInt(c(a).attr('data-page') || '1', 10);
                      })
                      .get(),
                  )),
                  (h = b.last().attr('href') || ''),
                  ...
                  return [3, 6];
                (m = h.slice(d).replace(/\d+$/, '')), (f = 2), (a.label = 3);
              case 3:
                return f <= p
                  ? [
                      4,
                      (0, t.fetchApi)(
                        this.site + l + 'ajax/chapters/' + m + f,
                        { method: 'POST', referrer: this.site + l },
                      ).then(function (e) {
                        return e.text();
                      }),
                    ]
              ...
              case 7:
                return (
                  ...
                  [
                    4,
                    (0, t.fetchApi)(this.site + 'wp-admin/admin-ajax.php', {
                      method: 'POST',
                      body: x,
                    }).then(function (e) {
                      return e.text();
              ...
              case 9:
                return (
                  ...
                  e('.wp-manga-chapter').each(function (a, l) {
                    var t = e(l).find('a').text().trim(),
                      r = l.attribs.class.includes('premium-block');
                    r && (t = '🔒 ' + t);
                    var n = e(l)
                      .find('span.chapter-release-date')
                      .text()
                      .trim();
                    n = n ? _.parseData(n) : (0, i.default)().format('LL');
                    var u = e(l).find('a').attr('href') || '';
                    !u ||
                      '#' == u ||
                      (r && _.hideLocked) ||
                      s.push({
      ...
      (l.prototype.parseChapter = function (l) {
        return e(this, void 0, void 0, function () {
          var e, t, r;
          return a(this, function (a) {
            switch (a.label) {
              ...
              case 1:
                return (
                  ...
                  [2, this.translateDragontea(t).html() || '']
                );
            }
          });
        });
      }),
      (l.prototype.searchNovels = function (l, t) {
        return e(this, void 0, void 0, function () {
          var e, r;
          return a(this, function (a) {
            switch (a.label) {
