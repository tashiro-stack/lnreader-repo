...
var l = require('cheerio'),
  ...
  u = (function () {
    ...
    return (
      ...
      (u.prototype.safeFecth = function (l, t) {
              ...
              case 2:
                if (
                  ...
                  (n =
                    null ===
                      (v =
                        null === (c = u.match(/<title>(.*?)<\/title>/)) ||
                        void 0 === c
                          ? void 0
                          : c[1]) || void 0 === v
                      ? void 0
                      : v.trim()),
                  this.getHostname(l) != this.getHostname(o.url) ||
                    (n &&
                      ('Bot Verification' == n ||
                        'You are being redirected...' == n ||
                        'Un instant...' == n ||
                        'Just a moment...' == n ||
                        'Redirecting...' == n)))
                )
          ...
          (e.match(/<article([^]*?)<\/article>/g) || []).forEach(function (e) {
            ...
            if (r && s) {
              var o =
                ...
                u = void 0;
              if (s.includes(a.site)) u = s.replace(a.site, '');
              else {
                var n = s.split('/');
                n.shift(), n.shift(), n.shift(), (u = n.join('/'));
              }
              t.push({
                name: r,
              ...
              case 0:
                for (r in ((t =
                  null !==
                    ...
                    ? v
                    : '/series/'),
                (s = this.site + t + '?page=' + e),
                b || (b = this.filters || {}),
                h && (s += '&order=latest'),
                b))
                  if ('object' == typeof b[r].value)
                    for (i = 0, o = b[r].value; i < o.length; i++)
                      (u = o[i]), (s += '&'.concat(r, '=').concat(u));
                  else
                    b[r].value && (s += '&'.concat(r, '=').concat(b[r].value));
      ...
      (u.prototype.parseNovel = function (l) {
        return e(this, void 0, void 0, function () {
          var e, s, o, u, c, v, b, h, p, d, f, m, g, y, w, k, x, N, C, S, L;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                  ...
                  (S = new t.Parser({
                    onopentag: function (a, l) {
                      ...
                      (null === (t = l.class) || void 0 === t
                        ...
                        ? ((o.name = l.title),
                          (o.cover = l['data-src'] || l.src || i.defaultCover))
                          ...
                          : b
                            ? h
                              ...
                              : 'div' === e &&
                                ((b = !1),
                                (o.author =
                                  null === (l = o.author) || void 0 === l
                                    ? void 0
                                    : l.trim()),
                                (o.artist =
                                  null === (t = o.artist) || void 0 === t
                                    ? void 0
                                    : t.trim()))
                            : m &&
                              (g
