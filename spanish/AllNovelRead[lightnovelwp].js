var e =
    (this && this.__awaiter) ||
    function (e, a, l, o) {
      return new (l || (l = Promise))(function (i, r) {
        function t(e) {
          try {
            u(o.next(e));
          } catch (e) {
  ...
  u = (function () {
    function u(e) {
      ...
      (this.version = '1.1.'.concat(10 + i)),
        ...
        (null === (o = this.options) || void 0 === o ? void 0 : o.hasLocked) &&
          (this.pluginSettings = {
            hideLocked: {
              value: '',
    ...
    return (
      ...
      (u.prototype.safeFecth = function (l, o) {
              ...
              case 2:
                if (
                  ...
                  (s =
                    null ===
                      (c =
                        null === (v = u.match(/<title>(.*?)<\/title>/)) ||
                        void 0 === v
                          ? void 0
                          : v[1]) || void 0 === c
                      ? void 0
                      : c.trim()),
                  this.getHostname(l) != this.getHostname(n.url) ||
                    (s &&
                      ('Bot Verification' == s ||
          ...
          (e.match(/<article([^]*?)<\/article>/g) || []).forEach(function (e) {
            ...
            if (r && i) {
              var n =
                ...
                u = void 0;
              if (i.includes(a.site)) u = i.replace(a.site, '');
              else {
                var s = i.split('/');
                s.shift(), s.shift(), s.shift(), (u = s.join('/'));
              }
              o.push({
                name: r,
                cover: n[2] || n[1] || t.defaultCover,
                path: u,
              });
            }
          }),
      ...
      (u.prototype.popularNovels = function (l, o) {
                  ...
                  null !==
                    (c =
                      null === (v = this.options) || void 0 === v
                        ? void 0
                        : v.seriesPath) && void 0 !== c
                    ? c
                    : '/series/'),
                (i = this.site + o + '?page=' + e),
                b || (b = this.filters || {}),
                d && (i += '&order=latest'),
                b))
                  if ('object' == typeof b[r].value)
                    for (t = 0, n = b[r].value; t < n.length; t++)
                      (u = n[t]), (i += '&'.concat(r, '=').concat(u));
                  else
                    b[r].value && (i += '&'.concat(r, '=').concat(b[r].value));
      ...
      (u.prototype.parseNovel = function (l) {
        return e(this, void 0, void 0, function () {
          var e, i, n, u, v, c, b, d, m, p, h, f, g, y, w, A, k, C, x, E, R;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (e = this.site), [4, this.safeFecth(e + l, !1)];
              case 1:
                return (
                  (i = a.sent()),
                  (n = {
                  ...
                  (E = new o.Parser({
                    onopentag: function (a, l) {
                      var o;
                      !n.cover &&
                      (null === (o = l.class) || void 0 === o
                        ? void 0
                        : o.includes('ts-post-image'))
                        ? ((n.name = l.title),
                          (n.cover = l['data-src'] || l.src || t.defaultCover))
                        : 'genxed' === l.class || 'sertogenre' === l.class
                          ? (u = !0)
                          : u && 'a' === a
                            ? (v = !0)
                            : 'div' !== a ||
                                ('entry-content' !== l.class &&
                                  'description' !== l.itemprop)
                              ? 'spe' === l.class || 'serl' === l.class
                                ? (b = !0)
                                : b && 'span' === a
                                  ? (d = !0)
                                  : 'div' === a && 'sertostat' === l.class
                                    ? ((b = !0), (d = !0), (h = !0))
                                    : l.class && l.class.includes('eplister')
                                      ? (f = !0)
                                      : f && 'li' === a
                                        ? (g = !0)
                                        : g
                    ...
                    ontext: function (e) {
                      var a, l;
                      if (u) v && (n.genres += e + ', ');
                      else if (1 === c && e.trim()) n.summary += e;
                      else if (b) {
                        if (d) {
                          var o = e.toLowerCase().replace(':', '').trim();
                          if (m) n.author += e || 'Unknown';
                          else if (p) n.artist += e || 'Unknown';
                          else if (h)
                            switch (o) {
                              case 'مكتملة':
                              case 'completed':
                              ...
                              case 'completado':
                              case 'tamamlandı':
                                n.status = r.NovelStatus.Completed;
                                break;
                              case 'مستمرة':
                              case 'ongoing':
                              case 'en cours':
                              ...
                              case 'en progreso':
                              case 'devam ediyor':
                                n.status = r.NovelStatus.Ongoing;
                                break;
                              case 'متوقفة':
                              case 'hiatus':
                              case 'en pause':
                              ...
                              case 'pausado':
                              case 'duraklatıldı':
                                n.status = r.NovelStatus.OnHiatus;
                                break;
                              default:
                                n.status = r.NovelStatus.Unknown;
                            }
                          switch (o) {
                            case 'الكاتب':
                            case 'author':
                        ...
                        if (1 === y)
                          ...
                          (C.name =
                            (null ===
                              ...
                              ? void 0
                              : l.trim()) || e.trim()),
                            C.chapterNumber || s(e, C);
                        else if (3 === y) C.releaseTime = e;
                        else if (4 === y) {
                          switch ((o = e.toLowerCase().trim())) {
                            case 'free':
                            case 'gratuit':
                            case 'مجاني':
                            case 'livre':
                          ...
                          : b
                            ? d
                              ...
                              : 'div' === e &&
                                ((b = !1),
                                (n.author =
                                  null === (l = n.author) || void 0 === l
                                    ? void 0
                                    : l.trim()),
                                (n.artist =
                                  null === (o = n.artist) || void 0 === o
                                    ? void 0
                                    : o.trim()))
                            : f &&
                              (g
                                ? 1 === y || 2 === y || 3 === y || 4 === y
                                  ...
                                  : 'li' === e &&
                                    ((g = !1),
                                    C.chapterNumber || (C.chapterNumber = 0),
                                    w && (C.name = '🔒 ' + C.name),
                                    (x && w) || k.push(C),
                                    (C = {}))
                                : 'ul' === e && (f = !1));
      ...
      (u.prototype.parseChapter = function (o) {
        return e(this, void 0, void 0, function () {
          var e, i, r, t, n;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return [4, this.safeFecth(this.site + o, !1)];
              case 1:
                if (
                  ((e = a.sent()),
                  null === (r = this.options) || void 0 === r
      ...
      (u.prototype.searchNovels = function (l, o) {
        return e(this, void 0, void 0, function () {
          var e, i;
          return a(this, function (a) {
            switch (a.label) {
              case 0:
                return (
                  (e =
                    this.site + 'page/' + o + '/?s=' + encodeURIComponent(l)),
  ...
  filters: {
    'genre[]': {
      ...
      options: [
        ...
        { label: 'Enemigos a los amantes', value: 'enemigos-a-los-amantes' },
        ...
        { label: 'Matrimonio por Contrato', value: 'matrimonio-por-contrato' },
        ...
        { label: 'Multimillonario-novela', value: 'multimillonario-novela' },
        ...
        { label: 'Protectormadre soltera', value: 'protectormadre-soltera' },
        {
    ...
    'type[]': {
      ...
      options: [
        ...
        { label: 'Historia-triste-novela', value: 'historia-triste-novela' },
