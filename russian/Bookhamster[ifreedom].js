    ...
    return (
      ...
      (a.prototype.parseNovel = function (a) {
        return e(this, void 0, void 0, function () {
          var e, u, o, s, c, v, b, h, p, f, d, m, g, y, k, w;
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [
                ...
                return (
                  ...
                  (w = new r.Parser({
                    onopentag: function (e, t) {
                      ...
                      'img' === e && h && !u.cover && (u.cover = t.src),
                        'div' === e &&
                          (a.includes('data-ranobe') && ((f = !0), (p = null)),
                          a.includes('data-value') && (d = !0),
                          a.includes('book-info-list') &&
                            ((f = !0), (p = null)),
                          a.includes('genreslist') && (p = 'genre')),
                        f &&
                          ('span' === e &&
...
var o = new u({
  id: 'bookhamster',
  sourceSite: 'https://bookhamster.ru',
  sourceName: 'Bookhamster',
  filters: {
    sort: {
      type: 'Picker',
      label: 'Сортировка:',
