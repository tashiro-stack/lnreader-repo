...
var a = require('@libs/fetch'),
  ...
  n = l(require('dayjs')),
  o = { 'User-Agent': 'RuLateApp Android', 'accept-encoding': 'gzip' },
  u = (function () {
    function l(e) {
      var t = this;
      (this.resolveUrl = function (e, l) {
        return t.site + '/book/' + e + (l ? '/' : '/ready_new');
      }),
        (this.id = e.id),
    ...
    return (
      (l.prototype.parseNovels = function (e) {
        return (0, a.fetchApi)(e, { headers: o })
          .then(function (e) {
            return e.json();
          })
          .then(function (e) {
      ...
      (l.prototype.popularNovels = function (l, a) {
        return e(this, arguments, void 0, function (e, l) {
          var a,
            r,
            n = l.filters,
            o = l.showLatestNovels;
          return t(this, function (t) {
            return (
              (a = this.site + '/api3/searchBooks?limit=40&page=' + e),
              (a +=
                '&sort=' +
                (o
                  ? '4'
              ...
              (a += '&key=' + this.key),
              [2, this.parseNovels(a)]
            );
          });
        });
      }),
      (l.prototype.searchNovels = function (l) {
        return e(this, arguments, void 0, function (e, l) {
          var a;
          return (
            void 0 === l && (l = 1),
            ...
            switch (t.label) {
              case 0:
                return [
                  4,
                  (0, a.fetchApi)(
                    this.site + '/api3/book?book_id=' + l + '&key=' + this.key,
                    { headers: o },
                  ).then(function (e) {
                    return e.json();
                  }),
                ...
                return (
                  ...
                  (u = {
                    ...
                    genres: [e.response.genres, e.response.tags]
                      .flatMap(function (e) {
                        var t;
                        return null === (t = null == e ? void 0 : e.map) ||
                          void 0 === t
                          ? void 0
                          : t.call(e, function (e) {
  ...
  filters: {
    ...
    genres: {
      ...
      options: [
        ...
        { label: 'городское фэнтези', value: '57' },
