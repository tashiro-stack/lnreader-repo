...
var u = require('@libs/filterInputs'),
  v = require('@libs/defaultCover'),
  b = require('@libs/fetch'),
  t = require('@libs/novelStatus'),
  n = a(require('dayjs')),
  r = {
    active: t.NovelStatus.Ongoing,
    completed: t.NovelStatus.Completed,
    freezed: t.NovelStatus.OnHiatus,
    unknown: t.NovelStatus.Unknown,
  },
  o = (function () {
    function a() {
      (this.id = 'TL'),
    ...
    return (
      (a.prototype.fetchNovels = function (a, u, t) {
          ...
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return [
                  4,
                  (0, b.fetchApi)(this.site + '/api/site/v2/graphql', {
                    method: 'post',
                    headers: {
              ...
              case 1:
                return (
                  ...
                  null ===
                    (p =
                      null === (c = null == l ? void 0 : l.projects) ||
                      void 0 === c
                        ? void 0
                        : c.content) ||
                    void 0 === p ||
      ...
      (a.prototype.popularNovels = function (a, u) {
        return l(this, arguments, void 0, function (l, a) {
          var u = a.filters;
          return e(this, function (e) {
            return [2, this.fetchNovels(l, u)];
          });
        });
      }),
      (a.prototype.searchNovels = function (a, u) {
        return l(this, void 0, void 0, function () {
          return e(this, function (l) {
            return [2, this.fetchNovels(u, void 0, a)];
          });
        });
      }),
      (a.prototype.parseNovel = function (a) {
        return l(this, void 0, void 0, function () {
          var l, u, o, i, s, c, p, h, f, d, m, g, y, j, N, q, S, w;
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return [
                ...
                return (
                  ...
                  (u = {
                    ...
                    cover: (
                      ...
                      ? this.site + l.project.covers[0].url
                      : v.defaultCover,
                    summary:
                      null ===
                        (d =
                          null === (f = l.project) || void 0 === f
                            ? void 0
                            : f.annotation) || void 0 === d
                        ? void 0
                        : d.text,
                    status:
                      r[
                        (null === (m = l.project) || void 0 === m
                          ? void 0
                          : m.translationStatus) || 'unknown'
                      ] || t.NovelStatus.Unknown,
                  }),
                  (null ==
                  (o = [
                    null === (g = l.project) || void 0 === g ? void 0 : g.tags,
                    null === (y = l.project) || void 0 === y
                      ? void 0
                      : y.genres,
                  ]
                    .flat()
                    .map(function (l) {
                      return (
                        (null == l ? void 0 : l.nameRu) ||
                        (null == l ? void 0 : l.nameEng)
                      );
                    })
                    .filter(function (l) {
                      return l;
                    ...
                    ? void 0
                    : o.length) && (u.genres = o.join(', ')),
                  null ===
                    (N =
                      null === (j = l.project) || void 0 === j
                        ? void 0
                        : j.persons) ||
                    void 0 === N ||
                  ...
                  null ===
                    (w =
                      null ===
                        (S =
                          null === (q = l.project) || void 0 === q
                            ? void 0
                            : q.subprojects) || void 0 === S
                        ? void 0
                        : S.content) ||
                    void 0 === w ||
                    w.forEach(function (l) {
                      return l.volumes.content.forEach(function (e, a) {
                        return e.chapters.forEach(function (u, v) {
                          u.published &&
                            i.push({
                              name:
                                (e.shortName || 'Том ' + (a + 1)) +
                                ...
                                (u.title || 'Глава ' + (v + 1)),
                              path: u.fullUrl,
                              releaseTime: (0, n.default)(u.publishDate).format(
                                'LLL',
                              ),
                              chapterNumber: i.length + 1,
                              page: l.title || 'Основная серия',
                            });
                        });
                      });
                    }),
