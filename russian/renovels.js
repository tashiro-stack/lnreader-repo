    ...
    return (
              ...
              case 0:
                for (
                  u = new URLSearchParams({
                    count: '30',
                    ordering: '-' + (d ? 'chapter_date' : y.sort.value),
                  }),
                    b = function (l, e) {
                      var a = e.value;
                      Array.isArray(a)
                        ...
                        : 'object' == typeof a &&
                          ...
                          null === (h = a.exclude) ||
                            ...
                            h.forEach(function (e) {
                              return u.append('exclude_'.concat(l), e);
                            }));
                    },
                    t = 0,
                    n = Object.entries(y);
                  ...
                  (r = n[t]), (i = r[0]), (o = r[1]), b(i, o);
                return (
                  u.append('page', l.toString()),
                  (s = ''
                    .concat(this.site, '/api/v2/search/catalog/?')
                    .concat(u.toString())),
                  [
                    4,
                    (0, v.fetchApi)(s).then(function (l) {
                      return l.json();
                    }),
                  ]
                );
              case 1:
                return (
                  ...
                  [
                    ...
                    c.map(function (l) {
                      return {
                        name: l.main_name || l.secondary_name,
                        cover:
                          f.site + (l.cover.high || l.cover.mid || l.cover.low),
                        path: l.dir,
                      };
                    }),
                  ]
      ...
      (a.prototype.parseNovel = function (a) {
        return l(this, void 0, void 0, function () {
          var l, u, n, r, i, o, s, c, p, h, f, d, y;
          return e(this, function (m) {
            switch (m.label) {
              case 0:
                return [
                  4,
                  (0, v.fetchApi)(this.site + '/api/titles/' + a).then(
                    function (l) {
                      return l.json();
                    },
                  ),
              ...
              case 1:
                (l = m.sent().content),
                  (u = {
                    path: a,
                    name: l.main_name || l.secondary_name || l.another_name,
                    summary: l.description,
                    cover:
                      this.site +
                      '/media/' +
                      (l.cover.high || l.cover.mid || l.cover.low),
                    status:
                      'Продолжается' === l.status.name
                        ? b.NovelStatus.Ongoing
                        : b.NovelStatus.Completed,
                  }),
                  (n = [
                    null == l ? void 0 : l.genres,
                    null == l ? void 0 : l.categories,
                  ]
                    .flat()
                    .map(function (l) {
                    ...
                    .filter(function (l) {
                      return l;
                    })).length && (u.genres = n.join(',')),
                  (r =
                    ((null ===
                      (f =
                        null === (h = l.branches) || void 0 === h
                          ? void 0
                          : h[0]) || void 0 === f
                      ? void 0
                      : f.count_chapters) || l.count_chapters) / 100),
                  (i =
                    (null ===
                      (y =
                        null === (d = l.branches) || void 0 === d
                          ? void 0
                          : d[0]) || void 0 === y
                      ? void 0
                      : y.id) || l.id),
                      ...
                      switch (e.label) {
                        ...
                        case 2:
                          return (
                            (u = e.sent()),
                            (b = !1),
                            u.content.forEach(function (l) {
                              !l.is_paid || l.is_bought
                                ? o.push({
                                    name:
                                      'Том ' +
                                      l.tome +
          ...
          return e(this, function (e) {
            switch (e.label) {
              case 0:
                return (
                  (l =
                    this.site + '/api/v2/titles/chapters/' + a.split('/')[1]),
                  [
                    4,
            ...
            e(this, function (e) {
              switch (e.label) {
                case 0:
                  return (
                    (u = ''
                      .concat(this.site, '/api/v2/search/?query=')
                      .concat(l, '&count=100&field=titles&page=')
                      .concat(a)),
                    [
                      4,
                      (0, v.fetchApi)(u).then(function (l) {
                        return l.json();
                      }),
                    ]
                  );
                  ...
                  return (
                    ...
                    b.forEach(function (l) {
                      return t.push({
                        name: l.main_name || l.secondary_name,
                        cover:
                          n.site + (l.cover.high || l.cover.mid || l.cover.low),
                        path: l.dir,
                      });
                    }),
                    [2, t]
