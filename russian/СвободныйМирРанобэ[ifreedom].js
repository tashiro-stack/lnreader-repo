            ...
            for (; i && ((i = 0), u[0] && (r = 0)), r; )
              try {
                if (
                  ...
                  return n;
                switch (((l = 0), n && (u = [2 & u[0], n.value]), u[0])) {
                  case 0:
                  case 1:
                    n = u;
                    break;
  ...
  u = (function () {
    function a(e) {
      (this.id = e.id),
        ...
        (this.icon = 'multisrc/ifreedom/'.concat(
          e.id.toLowerCase(),
          '/icon.png',
        )),
    ...
    return (
            ...
            var a = [],
              ...
              u = new r.Parser({
                onopentag: function (e, t) {
                  var a = t.class || '';
                  'div' === e &&
                    (a.includes('one-book-home') ||
                      a.includes('item-book-slide')) &&
                    (n = !0),
                    n &&
                      ('img' === e &&
                        ((l.cover = t.src), t.alt && (l.name = t.alt)),
                      'a' === e &&
                        t.href &&
                        ((l.path = t.href.replace(i, '')),
                        t.title && (l.name = t.title)));
                },
                onclosetag: function (e) {
                  'div' === e && n && ((n = !1), l.path && a.push(l), (l = {}));
                },
              });
            return u.write(e), u.end(), a;
          });
      }),
      (a.prototype.popularNovels = function (a, l) {
        return e(this, arguments, void 0, function (e, a) {
          var l,
            n,
            r = a.filters,
            i = a.showLatestNovels;
          return t(this, function (t) {
            return (
              (l = ''
                .concat(this.site, '/vse-knigi/?sort=')
                .concat(
                  i
                    ? 'По дате обновления'
                    : (null === (n = null == r ? void 0 : r.sort) ||
                      void 0 === n
                        ? void 0
                        : n.value) || 'По рейтингу',
                )),
              Object.entries(r || {}).forEach(function (e) {
                ...
                Array.isArray(a) &&
                  ...
                  (l += '&'
                    .concat(t, '[]=')
                    .concat(a.join('&'.concat(t, '[]='))));
              }),
              (l += '&bpage='.concat(e)),
              [2, this.parseNovels(l)]
            );
          });
        });
      }),
      (a.prototype.parseNovel = function (a) {
        return e(this, void 0, void 0, function () {
          var e, u, o, s, c, v, p, b, h, f, d, m, g, y, w, k;
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [
                  4,
                  (0, l.fetchApi)(this.site + a).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                  ...
                  (k = new r.Parser({
                    onopentag: function (e, t) {
                      ...
                      if (
                        ('h1' === e && (v = !0),
                        'div' === e &&
                          ((a.includes('block-book-slide-img') ||
                            a.includes('img-ranobe')) &&
                            (b = !0),
                          ('descr-ranobe' === a ||
                            ('active' === a &&
                              'Описание' === t['data-name'])) &&
                            (p = !0)),
                        p && 'span' === e && a.includes('open-desc'))
                      ) {
                        var l = t.onclick;
                        if (l) {
                          var n = l.match(/innerHTML\s*=\s*'([\s\S]+?)'/);
                          if (n && n[1]) {
                            var r = n[1];
                            (r = r
                              .replace(/&lt;br&gt;/gi, '\n')
                      ...
                      'img' === e && b && !u.cover && (u.cover = t.src),
                        'div' === e &&
                          (a.includes('data-ranobe') && ((f = !0), (h = null)),
                          a.includes('data-value') && (d = !0),
                          a.includes('book-info-list') &&
                            ((f = !0), (h = null)),
                          a.includes('genreslist') && (h = 'genre')),
                        f &&
                          ('span' === e &&
                            (a.includes('dashicons-book') &&
                            !a.includes('book-alt')
                              ? (h = 'genre')
                              : a.includes('admin-users')
                                ? (h = 'author')
                                : a.includes('megaphone') && (h = 'status')),
                          'svg' === e &&
                            (a.includes('icon-tabler-tag')
                              ? (h = 'genre')
                              : a.includes('mood-edit') ||
                                  a.includes('icon-tabler-user')
                                ? (h = 'author')
                                : (a.includes('chart-infographic') ||
                                    a.includes('megaphone')) &&
                                  (h = 'status'))),
                        'div' !== e ||
                          ('li-ranobe' !== a && 'chapterinfo' !== a) ||
                          (m = !0),
                        'a' === e &&
                          m &&
                          ((w.path = t.href.replace(c, '')), (g = !0)),
                        ('div' !== e && 'span' !== e) ||
                          ('li-col2-ranobe' !== a && 'timechapter' !== a) ||
                          (y = !0);
                    },
                    ontext: function (e) {
                      var t = e.trim();
                      if (t) {
                        if (
                          (v && (u.name = t.replace(/®/g, '').trim()),
                          p &&
                            'Прочесть полностью' !== t &&
                            (u.summary += t + '\n'),
                          h)
                        )
                          (d || (f && !d)) &&
                    ...
                    onclosetag: function (e) {
                      'h1' === e && (v = !1),
                        ...
                        ('div' !== e && 'span' !== e) ||
                          !y ||
                          ((y = !1), w.path && o.push(w), (w = {}), (m = !1));
                    },
                  })),
                  k.write(e),
                  k.end(),
                  (u.genres = s.join(',')),
                  (u.chapters = o.reverse()),
                  [2, u]
                );
            }
          });
            ...
            switch (t.label) {
              ...
              case 1:
                return (
                  ...
                  (r =
                    'bookhamster' === this.id
                      ? '\x3c!-- .entry-content --\x3e'
                      : '<div class="chapter-setting">'),
                  -1 === (i = e.indexOf(n))
                    ? [2, '']
                    : ((u = e.indexOf(r, i)),
                      (o = (o = e.slice(i, -1 !== u ? u : void 0)).replace(
                        /<script[^>]*>[\s\S]*?<\/script>/gim,
                        '',
                      )).includes('<img') &&
                        (o = o.replace(/srcset="([^"]+)"/g, function (e, t) {
                          if (!t) return e;
                          var a = t
                            .split(' ')
                            .filter(function (e) {
        ...
        return e(this, arguments, void 0, function (e, a) {
          ...
          return (
            ...
            t(this, function (t) {
              return (
                (l = ''
                  .concat(this.site, '/vse-knigi/?searchname=')
                  .concat(encodeURIComponent(e), '&bpage=')
                  .concat(a)),
                [2, this.parseNovels(l)]
              );
            })
...
var o = new u({
  id: 'ifreedom',
  sourceSite: 'https://ifreedom.su',
  sourceName: 'Свободный Мир Ранобэ',
  filters: {
    sort: {
      type: 'Picker',
      label: 'Сортировка:',
