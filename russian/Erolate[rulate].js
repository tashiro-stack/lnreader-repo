...
var t = require('@libs/fetch'),
  ...
  n = a(require('dayjs')),
  u = { 'User-Agent': 'RuLateApp Android', 'accept-encoding': 'gzip' },
  o = (function () {
    function a(e) {
      var l = this;
      (this.resolveUrl = function (e, a) {
        return l.site + '/book/' + e + (a ? '/' : '/ready_new');
      }),
        (this.id = e.id),
        (this.name = e.sourceName + ' (API)'),
        (this.icon = 'multisrc/rulate/'.concat(
          e.id.toLowerCase(),
          '/icon.png',
        )),
        (this.site = e.sourceSite),
        (this.version = '1.0.' + (1 + e.versionIncrements)),
        (this.filters = e.filters),
        (this.key = e.key);
    }
    return (
      (a.prototype.parseNovels = function (e) {
        return (0, t.fetchApi)(e, { headers: u })
          .then(function (e) {
            return e.json();
          })
          .then(function (e) {
      ...
      (a.prototype.popularNovels = function (a, t) {
        return e(this, arguments, void 0, function (e, a) {
          var t,
            r,
            n = a.filters,
            u = a.showLatestNovels;
          return l(this, function (l) {
            return (
              (t = this.site + '/api3/searchBooks?limit=40&page=' + e),
              (t +=
                '&sort=' +
                (u
                  ? '4'
                  : (null === (r = null == n ? void 0 : n.sort) || void 0 === r
                      ? void 0
                      : r.value) || '6')),
        ...
        return e(this, arguments, void 0, function (e, a) {
          ...
          return (
            ...
            l(this, function (l) {
              return (
                (t = ''
                  .concat(this.site, '/api3/searchBooks?t=')
                  .concat(encodeURIComponent(e), '&limit=40&page=')
                  .concat(a, '&key=')
                  .concat(this.key)),
                [2, this.parseNovels(t)]
              );
            ...
            switch (l.label) {
              case 0:
                return [
                  4,
                  (0, t.fetchApi)(
                    this.site + '/api3/book?book_id=' + a + '&key=' + this.key,
                    { headers: u },
                  ).then(function (e) {
                    return e.json();
                  }),
              ...
              case 1:
                return (
                  (e = l.sent()),
                  (o = {
                    name: e.response.t_title || e.response.s_title,
                    path: a,
                    cover: e.response.img,
                    genres: [e.response.genres, e.response.tags]
                      .flatMap(function (e) {
                        var l;
                        return null === (l = null == e ? void 0 : e.map) ||
                          void 0 === l
                          ? void 0
                          : l.call(e, function (e) {
                      ...
                      .join(','),
                    summary: e.response.description,
                    author: e.response.author,
                    status:
                      'Завершён' === e.response.status
                        ? r.NovelStatus.Completed
                        : r.NovelStatus.Ongoing,
                    rating:
                      e.response.rate && e.response.rate.count > 0
                        ? Number(
                            (
                              e.response.rate.sum / e.response.rate.count
                            ).toFixed(2),
                          )
                        : void 0,
                  }),
              ...
              case 2:
                return (
                  ...
                  (s = []),
                  i.response &&
                    Array.isArray(i.response) &&
                    i.response.forEach(function (e) {
                      e.can_read &&
                        0 === e.subscription &&
                        s.push({
                          name: e.title + (e.illustrated ? ' 🖼️' : ''),
                          path: a + '/' + e.id,
                          releaseTime: (0, n.default)(1e3 * e.cdate).format(
                            'LLL',
                          ),
                          chapterNumber: e.ord,
                        });
  ...
  filters: {
    ...
    genres: {
      ...
      options: [
        ...
        { label: 'Арт', value: '70' },
        { label: 'бдсм', value: '3' },
        { label: 'Боевые искусства', value: '52' },
        ...
        { label: 'Гарем', value: '71' },
        { label: 'гендарная интрига', value: '12' },
        { label: 'Героическое фэнтези', value: '57' },
        { label: 'групповой секс', value: '13' },
        { label: 'детектив', value: '39' },
        { label: 'Детектив', value: '50' },
        { label: 'Дзёсэй', value: '45' },
        { label: 'драма', value: '14' },
        { label: 'Драма', value: '46' },
