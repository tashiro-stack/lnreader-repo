  ...
  u = (function () {
    function a() {
      ...
      (this.id = 'bookriver'),
        ...
        (this.resolveUrl = function (t, a) {
          return e.site + (a ? '/book/' : '/reader/') + t;
        }),
        (this.filters = {
          sort: {
            label: 'Сортировка',
    ...
    return (
              ...
              case 0:
                return (
                  (l =
                    ...
                    '/genre?page=' +
                    e +
                    '&perPage=24&sortingType='),
                  (l += d
                    ? 'last-update'
                    : (null === (v = null == k ? void 0 : k.sort) ||
                      void 0 === v
                        ? void 0
                        : v.value) || 'bestseller'),
                  (null ===
                    (p =
                      null === (c = null == k ? void 0 : k.genres) ||
                      void 0 === c
                        ? void 0
                        : c.value) || void 0 === p
                    ? void 0
                    : p.length) && (l += '&g=' + k.genres.value.join(',')),
                  [
                    4,
                    (0, i.fetchApi)(l).then(function (e) {
                      return e.text();
                    }),
                  ]
                );
                    ...
                    null ===
                      (f =
                        null ===
                          (b =
                            null ===
                              (h = s.props.pageProps.state.pagesFilter) ||
                            void 0 === h
                              ? void 0
                              : h.genre) || void 0 === b
                          ? void 0
      ...
      (a.prototype.parseNovel = function (a) {
        return e(this, void 0, void 0, function () {
          var e, l, u, s, v, c, p, h, b, f;
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return [
                  4,
                  (0, i.fetchApi)(this.resolveUrl(a, !0)).then(function (e) {
                    return e.text();
                  }),
                ];
              case 1:
                return (
                  (e = t.sent()),
                  (l = { path: a, name: '' }),
                  (u = e.match(r)) instanceof Array &&
                    u[1] &&
                    ((s = JSON.parse(u[1]).props.pageProps.state.book.bookPage),
                    (l.name = s.name || ''),
                    (l.cover = s.coverImages[0].url),
                    (l.summary = s.annotation),
                    (l.author =
                      null === (c = s.author) || void 0 === c
                        ? void 0
                        : c.name),
                    (l.status =
                      'writing' === (null == s ? void 0 : s.statusComplete)
                        ? n.NovelStatus.Ongoing
                        : n.NovelStatus.Completed),
                    (null === (p = s.tags) || void 0 === p
                      ? void 0
                      : p.length) &&
                      (l.genres =
                        null === (h = s.tags) || void 0 === h
                          ? void 0
                          : h
                              .map(function (e) {
                                return e.name;
                    ...
                    (null ===
                      ...
                      : f.length) &&
                      ((v = []),
                      s.ebook.chapters.forEach(function (e, t) {
                        e.available &&
                          v.push({
                            name: e.name,
                            path: a + '/' + e.chapterId,
                            releaseTime: (0, o.default)(
                              e.firstPublishedAt || e.createdAt || void 0,
                            ).format('LLL'),
                            chapterNumber: t + 1,
                          });
                      }),
        ...
        return e(this, void 0, void 0, function () {
          ...
          return t(this, function (t) {
            switch (t.label) {
              case 0:
                return (
                  (e = this.apiSite + 'books/chapter/text/'),
                  [
                    4,
                    (0, i.fetchApi)(e + a.split('/').pop()).then(function (e) {
                      return e.json();
                    }),
                  ]
                );
              case 1:
                return (
                  (l = t.sent().data),
                  (n = l.content || 'Конец произведения'),
                  (null === (o = null == l ? void 0 : l.audio) || void 0 === o
                    ? void 0
                    : o.available) && (n += '\n' + l.audio.url),
                  [2, n]
                );
